      ...
      borderBottom: '1px solid #e5e5e5'
        ...
        flexWrap: 'wrap'
          ...
          color: '#555'
              ...
              <PaginatedDemo variant={variant} position={position} align={align} label={\`Table pagination (\${variant}, \${position}, \${align})\`} />
            </div>)))}
    </div>
