...
`)}},C={render:()=>{let e=g,[t,n]=(0,f.useState)(0),[r,i]=(0,f.useState)(!0),[o,s]=(0,f.useState)(0);return(0,f.useEffect)(()=>{if(!r)return;if(t>=e.length){i(!1);return}let a=Math.floor(Math.random()*8)+2,o=30+Math.random()*60,s=setTimeout(()=>{n(t=>Math.min(t+a,e.length))},o);return()=>clearTimeout(s)},[t,r,e]),(0,p.jsxs)(`div`,{children:[(0,p.jsxs)(`div`,{style:{marginBlockEnd:12,display:`flex`,gap:8,alignItems:`center`},children:[(0,p.jsx)(a,{label:`Replay`,variant:`secondary`,size:`sm`,onClick:(0,f.useCallback)(()=>{n(0),i(!0),s(e=>e+1)},[]),isDisabled:r}),(0,p.jsx)(`span`,{style:{fontSize:12,color:`var(--color-text-secondary)`},children:r?`Streaming... ${t}/${e.length}`:`Complete`})]}),(0,p.jsx)(u,{isStreaming:r,density:`compact`,headingLevelStart:3,children:e.slice(0,t)},o)]})}},w={name:`With Images`,render:()=>(0,p.jsx)(`div`,{style:{maxWidth:800},children:(0,p.jsx)(u,{children:`
