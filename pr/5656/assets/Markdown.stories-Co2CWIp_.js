...
`)}},C={render:()=>{let e=g,[t,n]=(0,f.useState)(0),[r,i]=(0,f.useState)(!0),[o,s]=(0,f.useState)(0);return(0,f.useEffect)(()=>{if(!r)return;if(t>=e.length){i(!1);return}let a=Math.floor(Math.random()*8)+2,o=30+Math.random()*60,s=setTimeout(()=>{n(t=>Math.min(t+a,e.length))},o);return()=>clearTimeout(s)},[t,r,e]),(0,p.jsxs)(`div`,{children:[(0,p.jsxs)(`div`,{style:{marginBlockEnd:12,display:`flex`,gap:8,alignItems:`center`},children:[(0,p.jsx)(a,{label:`Replay`,variant:`secondary`,size:`sm`,onClick:(0,f.useCallback)(()=>{n(0),i(!0),s(e=>e+1)},[]),isDisabled:r}),(0,p.jsx)(`span`,{style:{fontSize:12,color:`var(--color-text-secondary)`},children:r?`Streaming... ${t}/${e.length}`:`Complete`})]}),(0,p.jsx)(d,{isStreaming:r,density:`compact`,headingLevelStart:3,children:e.slice(0,t)},o)]})}},w={name:`With Images`,render:()=>(0,p.jsx)(`div`,{style:{maxWidth:800},children:(0,p.jsx)(d,{children:`
...
`)})})},k=({value:e,display:t})=>(0,p.jsx)(t===`block`?`div`:`span`,{role:`math`,"aria-label":`Formula: ${e}`,style:{display:t===`block`?`block`:`inline`,padding:t===`block`?`12px 16px`:`1px 4px`,marginBlock:t===`block`?12:void 0,border:`1px solid var(--color-border)`,borderRadius:6,fontFamily:`serif`,fontStyle:`italic`,textAlign:t===`block`?`center`:void 0},children:e}),A={name:`Custom Math Renderer`,render:()=>(0,p.jsx)(`div`,{style:{maxWidth:680},children:(0,p.jsx)(d,{components:{math:k},children:`A renderer can typeset inline math such as $E = mc^2$ without preprocessing the source.

$$
\\sum_{i=1}^{n} i = \\frac{n(n+1)}{2}
$$

Code remains opaque: \`$not_math$\`.`})})},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  args: {
    children: SAMPLE_MD
  }
...
}`,...A.parameters?.docs?.source}}},j=[`Default`,`Compact`,`AIResponse`,`ShiftedHeadings`,`InlineDisplay`,`TableFocused`,`Streaming`,`WithImages`,`ContentAlignStart`,`ContentAlignCenter`,`InlinePlugins`,`CustomMath`]}))();export{y as AIResponse,v as Compact,D as ContentAlignCenter,E as ContentAlignStart,A as CustomMath,_ as Default,x as InlineDisplay,O as InlinePlugins,b as ShiftedHeadings,C as Streaming,S as TableFocused,w as WithImages,j as __namedExportsOrder,m as default};