import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{D as r,E as i}from"./ime-Dy4QRKoo.js";import{P as a,t as o}from"./utils-eYNPhPe_.js";import{t as s}from"./jsx-runtime-DqZldVDK.js";import{n as c}from"./useTooltip-DAlyoPtn.js";import{l,t as u}from"./i18n-CbA7usjw.js";import{n as d,t as f}from"./useDevWarning-DOihtqnx.js";import{t as p}from"./Tooltip-Cg5Ktddr.js";import{n as m,t as h}from"./Field-DJNi8Gdb.js";import{a as g,i as _,n as v,o as y,r as b,s as x}from"./List-D2Nav2Dv.js";import{i as S,n as C,r as w,t as T}from"./CheckboxInput-AH0Ol5Da.js";function E({label:e,isLabelHidden:t=!1,description:n,status:i,value:o,onChange:s,changeAction:l,density:u=`balanced`,hasDividers:d=!1,isDisabled:f=!1,disabledMessage:p,isReadOnly:m=!1,children:g,ref:v,width:y,xstyle:b,className:x,style:S,"data-testid":C,...T}){let E=(0,D.useId)(),A=(0,D.useId)(),j=(0,D.useId)(),M=(0,D.useId)(),[,N]=(0,D.useTransition)(),P=o!==void 0,[F,I]=(0,D.useOptimistic)(o??k),[L,R]=(0,D.useOptimistic)(null),z=f&&!!p,B=c({placement:`above`,focusTrigger:`always`,isEnabled:z}),V=(0,D.useCallback)((e,t)=>{s?.(e),l&&N(async()=>{I(e),t!==void 0&&R(t),await l(e)})},[s,l,N,I,R]),H=(0,D.useMemo)(()=>({value:P?F:void 0,onChange:P?V:void 0,isDisabled:f,hasDisabledMessage:z,isReadOnly:m,loadingValue:L}),[P,F,V,f,z,m,L]);return(0,O.jsxs)(h,{...T,ref:v,"data-testid":C,label:e,isLabelHidden:t,description:n,inputID:E,labelID:A,isGroupLabel:!0,descriptionID:n?j:void 0,isDisabled:f,status:i?{type:i.type,message:i.message,messageID:i.message?M:void 0}:void 0,statusVariant:`detached`,width:y,xstyle:b,...a(r(`checkbox-list`),{className:x,style:S}),children:[(0,O.jsx)(w,{value:H,children:(0,O.jsx)(`div`,{ref:e=>{B.ref(e)},role:`group`,"aria-labelledby":A,"aria-describedby":[n?j:null,i?.message?M:null,z?B.describedBy:null].filter(Boolean).join(` `)||void 0,children:(0,O.jsx)(_,{density:u,hasDividers:d,children:g})})}),z&&B.renderTooltip(p)]})}var D,O,k,A=e((()=>{D=t(n(),1),m(),g(),p(),o(),i(),S(),O=s(),k=[],E.displayName=`CheckboxList`,E.__docgenInfo={description:`A checkbox group component for multi-value selection.
...
@default false`,defaultValue:{value:`false`,computed:!1}},width:{required:!1,tsType:{name:`union`,raw:`number | string`,elements:[{name:`number`},{name:`string`}]},description:"Width of the field. Numbers are treated as pixels, strings are used as-is\n(e.g. `'100%'`). Sizes the whole field (label, control, and status) so they\nstay aligned, unlike setting width via `xstyle`/`className`/`style`."},children:{required:!0,tsType:{name:`ReactNode`},description:`Checkbox list items to render.`}},composes:[`Omit`]}}));function j({label:e,"aria-label":t,value:n,description:r,endContent:i,isDisabled:a=!1,isLoading:o=!1,isChecked:s,onCheck:c,ref:u,xstyle:f,className:p,style:m,onClick:h,...g}){let _=l(),b=(0,M.use)(w);if(b&&b.value!==void 0&&n===void 0)throw Error("CheckboxListItem requires a `value` prop when used inside CheckboxList with a value array.");let x=t??(typeof e==`string`?e:_(`@astryx.checkboxList.item.checkbox`));d(`CheckboxListItem`,'`label` is a ReactNode, so the checkbox falls back to the generic accessible name "Checkbox". Pass `aria-label` with a concise string equivalent of the visible label so screen readers can tell items apart.',typeof e!=`string`&&t==null);let S=((0,M.use)(y)?.density??`balanced`)===`compact`?`sm`:`md`,C=(b?.isDisabled??!1)||a,E=b?.isReadOnly??!1,D=o||(b?.loadingValue!=null&&n!==void 0?b.loadingValue===n:!1),O=!1;b&&b.value!==void 0&&n!==void 0?O=b.value.includes(n):s!==void 0&&(O=s);let k=!E&&(b!=null||c!=null),A=(0,M.useRef)(null),j=k||h!=null,F=()=>{C||E||D||(b&&b.value!==void 0&&n!==void 0?b.value.includes(n)?b.onChange?.(b.value.filter(e=>e!==n),n):b.onChange?.([...b.value,n],n):c?.(O!==!0))};return(0,N.jsx)(v,{...g,ref:u,label:e,description:r,endContent:i,isDisabled:C,interactiveRef:j?A:void 0,"aria-busy":D||void 0,xstyle:[O===!0&&!C&&!E&&P.selected,f],className:p,style:m,startContent:(0,N.jsx)(T,{ref:A,label:x,isLabelHidden:!0,value:O,onChange:()=>F(),onClick:h,isDisabled:C,isReadOnly:E,isLoading:D,size:S})})}var M,N,P,F=e((()=>{M=t(n(),1),f(),C(),b(),x(),S(),u(),N=s(),P={selected:{kWkggS:`astryxgcxg3y`,$$css:!0}},j.displayName=`CheckboxListItem`,j.__docgenInfo={description:`A checkbox item for use within CheckboxList (collection mode)
...
delegate to the checkbox.`},"aria-label":{required:!1,tsType:{name:`string`},description:`Plain-text accessible name for the checkbox when \`label\` is a ReactNode.
