...
Avoid global state managers unless you have a genuine need for cross-cutting state. Most apps are over-engineered in this area.`}),(0,A.jsx)(h,{timestamp:(0,A.jsx)(x,{value:`2026-03-15T14:30:30`,format:`time`}),footer:(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`span`,{children:`Claude Opus 4.6`}),(0,A.jsx)(`span`,{children:`·`}),(0,A.jsx)(r,{label:`Thumbs up`,icon:(0,A.jsx)(D,{style:{width:14,height:14}}),variant:`ghost`,size:`sm`,isIconOnly:!0}),(0,A.jsx)(r,{label:`Thumbs down`,icon:(0,A.jsx)(O,{style:{width:14,height:14}}),variant:`ghost`,size:`sm`,isIconOnly:!0}),(0,A.jsx)(r,{label:`Copy`,icon:(0,A.jsx)(E,{style:{width:14,height:14}}),variant:`ghost`,size:`sm`,isIconOnly:!0})]})})]}),(0,A.jsx)(T,{sender:`user`,children:(0,A.jsx)(g,{metadata:(0,A.jsx)(h,{timestamp:(0,A.jsx)(x,{value:`2026-03-15T14:31:00`,format:`time`}),status:`read`}),children:`Can you show me a useReducer example?`})}),(0,A.jsxs)(T,{sender:`assistant`,children:[(0,A.jsx)(v,{density:`compact`,children:`Here's a common pattern for form state:`}),(0,A.jsx)(s,{code:`const reducer = (state, action) => {
  switch (action.type) {
    case 'SET_FIELD':
