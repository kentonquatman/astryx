import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{i,t as a}from"./Avatar-BhbvgEd4.js";import{Sr as o,Ur as s,Vr as c,wr as l,xr as u,zr as d}from"./iframe-Y-SqSYW9.js";import{Nn as f,t as p}from"./src-DzD-zZ9s.js";var m,h,g,_,v,y,b,x,S;e((()=>{l(),p(),a(),u(),m=t(n()),h=r(),g={title:`Lab/ChatReasoning`,component:f,tags:[`autodocs`],parameters:{layout:`centered`},decorators:[e=>(0,h.jsx)(`div`,{style:{width:600,padding:40},children:(0,h.jsx)(e,{})})]},_={render:()=>(0,h.jsx)(f,{duration:`12s`,children:`Let me work through the constraints systematically. The farmer has 3 fields and rotates wheat, corn, soy. No same crop in adjacent fields and no same crop in the same field two years in a row...`})},v={render:()=>(0,h.jsx)(f,{duration:`8s`,defaultIsExpanded:!0,children:(0,h.jsx)(o,{density:`compact`,children:`First, I need to understand the constraints:
...
For **Year 1**: 3 × 2 × 2 = 12 arrangements...`})})},y={render:()=>{let[e,t]=(0,m.useState)(!0);return(0,m.useEffect)(()=>{let e=setTimeout(()=>t(!1),5e3);return()=>clearTimeout(e)},[]),(0,h.jsxs)(`div`,{children:[(0,h.jsx)(f,{isStreaming:e,label:`Thinking`,children:`Working through the combinatorial constraints...`}),!e&&(0,h.jsx)(`p`,{style:{marginTop:8,fontSize:13,color:`var(--color-text-secondary)`},children:`(Shimmer stopped after 5s)`})]})}},b={render:()=>(0,h.jsx)(f,{label:`Analyzing`,duration:`3s`,children:`Checking the codebase for similar patterns...`})},x={render:()=>(0,h.jsxs)(s,{children:[(0,h.jsx)(c,{sender:`user`,children:(0,h.jsx)(d,{children:`How many valid planting arrangements are possible over 3 years?`})}),(0,h.jsxs)(c,{sender:`assistant`,avatar:(0,h.jsx)(i,{name:`AI`,size:`md`}),children:[(0,h.jsx)(f,{duration:`12s`,children:`Let me work through the constraints systematically...`}),(0,h.jsx)(o,{density:`compact`,children:`There are **42** valid planting arrangements over 3 years.`})]})]})},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
