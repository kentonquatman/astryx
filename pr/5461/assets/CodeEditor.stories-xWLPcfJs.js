import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{t as i,zn as a}from"./src-DzD-zZ9s.js";function o(e){let[t,n]=(0,s.useState)(e.value??u);return(0,c.jsx)(a,{label:`Code editor`,language:`typescript`,hasLineNumbers:!0,...e,value:t,onChange:n})}var s,c,l,u,d,f,p,m,h,g,_,v;e((()=>{s=t(n()),i(),c=r(),l={title:`Lab/CodeEditor`,component:a,tags:[`autodocs`],argTypes:{language:{control:`select`,options:[`typescript`,`javascript`,`json`,`html`,`css`,`python`,`bash`,`php`,`hack`,`yaml`,`markdown`,`plaintext`]},size:{control:`select`,options:[`sm`,`md`]},hasLineNumbers:{control:`boolean`},isReadOnly:{control:`boolean`}}},u=`function greet(name: string): string {
