import{i as e}from"./preload-helper-CT_b8DTk.js";import{F as t,I as n}from"./ime-ByhR7fBS.js";import{c as r,t as i}from"./utils-5hOvTTOG.js";import{t as a}from"./jsx-runtime-DqZldVDK.js";import{t as o}from"./Icon-BBqJ19fg.js";import{t as s}from"./Icon-BS0Bw2s6.js";import{d as c}from"./renderDropdownItems-Dsg9T3ks.js";import{i as l}from"./Stack-DlhhdjPh.js";import{t as u}from"./Layout-Cd9a3PeZ.js";import{Si as d,bi as f,yi as p}from"./iframe-gr2b9Ivs.js";import{Wt as m,bt as h,ot as g,t as _}from"./esm-BNuSW8ar.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R;e((()=>{t(),p(),s(),u(),i(),_(),v=a(),y={title:`Core/Breadcrumbs`,component:d,tags:[`autodocs`],argTypes:{separator:{control:`text`,description:`Separator between items`},label:{control:`text`,description:`Accessible label for the nav landmark`},variant:{control:`select`,options:[`default`,`supporting`],description:`Visual variant controlling text size and color`}}},b={render:()=>(0,v.jsxs)(d,{children:[(0,v.jsx)(f,{href:`/`,children:`Home`}),(0,v.jsx)(f,{href:`/projects`,children:`Projects`}),(0,v.jsx)(f,{isCurrent:!0,children:`My Project`})]})},x={render:()=>(0,v.jsxs)(d,{children:[(0,v.jsx)(f,{href:`/`,children:`Home`}),(0,v.jsx)(f,{isCurrent:!0,children:`Settings`})]})},S={name:`Auto-detect Current`,render:()=>(0,v.jsxs)(d,{children:[(0,v.jsx)(f,{href:`/`,children:`Home`}),(0,v.jsx)(f,{href:`/projects`,children:`Projects`}),(0,v.jsx)(f,{children:`Auto Current`})]})},C={tags:[`visual-baseline`],render:()=>(0,v.jsxs)(l,{gap:3,children:[(0,v.jsxs)(d,{label:`Automatic bidi separator`,separator:`›`,children:[(0,v.jsx)(f,{href:`/`,children:`Home`}),(0,v.jsx)(f,{href:`/docs`,children:`Docs`}),(0,v.jsx)(f,{isCurrent:!0,children:`API Reference`})]}),(0,v.jsxs)(d,{label:`Explicitly mirrored separator`,separator:(0,v.jsx)(`span`,{...n(r.mirror),children:`→`}),children:[(0,v.jsx)(f,{href:`/`,children:`Home`}),(0,v.jsx)(f,{href:`/docs`,children:`Docs`}),(0,v.jsx)(f,{isCurrent:!0,children:`API Reference`})]})]})},w={render:()=>(0,v.jsxs)(d,{children:[(0,v.jsx)(f,{href:`/`,startIcon:(0,v.jsx)(g,{width:16,height:16,"aria-hidden":`true`}),children:`Home`}),(0,v.jsx)(f,{href:`/settings`,startIcon:(0,v.jsx)(m,{width:16,height:16,"aria-hidden":`true`}),children:`Settings`}),(0,v.jsx)(f,{isCurrent:!0,children:`Profile`})]})},T={render:()=>(0,v.jsxs)(d,{children:[(0,v.jsx)(f,{href:`/`,onClick:e=>{e.preventDefault(),console.log(`Navigate to Home`)},children:`Home`}),(0,v.jsx)(f,{href:`/projects`,onClick:e=>{e.preventDefault(),console.log(`Navigate to Projects`)},children:`Projects`}),(0,v.jsx)(f,{isCurrent:!0,children:`Detail`})]})},E={render:()=>(0,v.jsxs)(d,{children:[(0,v.jsx)(f,{href:`/`,children:`Home`}),(0,v.jsx)(f,{href:`/products`,children:`Products`}),(0,v.jsx)(f,{href:`/products/electronics`,children:`Electronics`}),(0,v.jsx)(f,{href:`/products/electronics/phones`,children:`Phones`}),(0,v.jsx)(f,{isCurrent:!0,children:`iPhone 15 Pro`})]})},D={name:`Supporting Variant`,render:()=>(0,v.jsxs)(d,{variant:`supporting`,children:[(0,v.jsx)(f,{href:`/`,children:`Home`}),(0,v.jsx)(f,{href:`/projects`,children:`Projects`}),(0,v.jsx)(f,{isCurrent:!0,children:`My Project`})]})},O={name:`Supporting Variant with Icons`,render:()=>(0,v.jsxs)(d,{variant:`supporting`,children:[(0,v.jsx)(f,{href:`/`,startIcon:(0,v.jsx)(g,{width:14,height:14,"aria-hidden":`true`}),children:`Home`}),(0,v.jsx)(f,{href:`/projects`,startIcon:(0,v.jsx)(h,{width:14,height:14,"aria-hidden":`true`}),children:`Projects`}),(0,v.jsx)(f,{isCurrent:!0,children:`My Project`})]})},k={name:`Current on Middle Item`,render:()=>(0,v.jsxs)(d,{children:[(0,v.jsx)(f,{href:`/`,children:`Home`}),(0,v.jsx)(f,{isCurrent:!0,children:`Projects`}),(0,v.jsx)(f,{href:`/projects/my-project/settings`,children:`Settings`})]})},A=[{label:`Design`,onClick:()=>console.log(`go /team/design`)},{label:`Engineering`,onClick:()=>console.log(`go /team/eng`)},{type:`divider`},{label:`Data`,icon:`chart`,onClick:()=>console.log(`go /team/data`)}],j={name:`Menu Crumb (data array)`,render:()=>(0,v.jsxs)(d,{children:[(0,v.jsx)(f,{href:`/`,children:`Home`}),(0,v.jsx)(f,{menu:A,children:`Teams`}),(0,v.jsx)(f,{isCurrent:!0,children:`Overview`})]})},M={name:`Menu Crumb (composed children)`,render:()=>(0,v.jsxs)(d,{children:[(0,v.jsx)(f,{href:`/`,children:`Home`}),(0,v.jsx)(f,{menu:(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)(c,{label:`Overview`,onClick:()=>console.log(`overview`)}),(0,v.jsx)(c,{label:`Settings`,icon:`gear`,onClick:()=>console.log(`settings`)})]}),children:`Project`}),(0,v.jsx)(f,{isCurrent:!0,children:`Details`})]})},N={name:`Mirrored Icon Separator`,render:()=>(0,v.jsxs)(d,{separator:(0,v.jsx)(o,{icon:`chevronRight`,size:`xsm`,color:`secondary`,xstyle:r.mirror}),children:[(0,v.jsx)(f,{href:`/`,children:`Home`}),(0,v.jsx)(f,{href:`/docs`,children:`Docs`}),(0,v.jsx)(f,{isCurrent:!0,children:`API Reference`})]})},P={name:`Long Labels in a Narrow Container`,render:()=>(0,v.jsx)(`div`,{style:{width:320,outline:`1px dashed #ccc`},children:(0,v.jsxs)(d,{children:[(0,v.jsx)(f,{href:`/`,children:`Home`}),(0,v.jsx)(f,{href:`/reports`,children:`Quarterly Financial Reconciliation`}),(0,v.jsx)(f,{isCurrent:!0,children:`Consolidated Statement of Operations 2026 Q3`})]})})},F={render:()=>(0,v.jsx)(d,{children:(0,v.jsx)(f,{isCurrent:!0,children:`Only Page`})})},I=[{label:`Design`,onClick:()=>console.log(`go /team/design`)},{label:`Engineering`,isDisabled:!0},{type:`divider`},{label:`Data`,icon:`chart`,onClick:()=>console.log(`go /team/data`)}],L={name:`Menu Crumb (disabled item)`,render:()=>(0,v.jsxs)(d,{children:[(0,v.jsx)(f,{href:`/`,children:`Home`}),(0,v.jsx)(f,{menu:I,children:`Teams`}),(0,v.jsx)(f,{isCurrent:!0,children:`Overview`})]}),play:async({canvasElement:e})=>{let t=e.querySelector(`nav button`);t instanceof HTMLElement&&t.click()}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  render: () => <Breadcrumbs>
