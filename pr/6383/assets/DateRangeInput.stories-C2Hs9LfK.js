import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{c as i}from"./useTheme-DSFSoLLi.js";import{t as a,x as o}from"./theme-BF2Ivntt.js";import{n as s,t as c}from"./DateRangeInput-C5LoDQaZ.js";function l(e){let t=new Date;return t.setDate(t.getDate()-e),t.toISOString().slice(0,10)}function u(){return new Date().toISOString().slice(0,10)}function d(){let e=new Date;return e.setDate(1),e.toISOString().slice(0,10)}var f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R;e((()=>{f=t(n()),c(),a(),p=r(),m=[{label:`Last 1 day`,getRange:()=>({start:l(1),end:u()})},{label:`Last 3 days`,getRange:()=>({start:l(3),end:u()})},{label:`Last 7 days`,getRange:()=>({start:l(7),end:u()})},{label:`Last 14 days`,getRange:()=>({start:l(14),end:u()})},{label:`Last 30 days`,getRange:()=>({start:l(30),end:u()})},{label:`This month`,getRange:()=>({start:d(),end:u()})}],h={title:`Core/DateRangeInput`,component:s,tags:[`autodocs`],argTypes:{label:{control:`text`,description:`Label text (required)`},isLabelHidden:{control:`boolean`,description:`Visually hide the label`},placeholder:{control:`text`,description:`Placeholder text`},description:{control:`text`,description:`Description text`},isOptional:{control:`boolean`,description:`Show optional indicator`},isRequired:{control:`boolean`,description:`Mark as required`},isDisabled:{control:`boolean`,description:`Disable the picker`},disabledMessage:{control:`text`,description:`Explains why the input is disabled. With isDisabled, shows a tooltip on hover/keyboard focus and keeps the field focusable via aria-disabled (activation stays blocked). Use this instead of wrapping a disabled DateRangeInput in Tooltip.`},size:{control:`radio`,options:[`sm`,`md`,`lg`]},hasClear:{control:`boolean`,description:`Show clear button`},numberOfMonths:{control:`radio`,options:[1,2],description:`Calendar months`}}},g={render:e=>{let[t,n]=(0,f.useState)(null);return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Date range`}},_={render:e=>{let[t,n]=(0,f.useState)({start:`2026-03-10`,end:`2026-03-20`});return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Report period`}},v={render:e=>{let[t,n]=(0,f.useState)(null);return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Date range`,presets:m}},y={render:e=>{let[t,n]=(0,f.useState)({start:l(7),end:u()});return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Analytics period`,presets:m}},b={render:e=>{let[t,n]=(0,f.useState)(null);return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Constrained analytics period`,presets:m,maxRangeSpan:1},play:async({canvasElement:e})=>{let t=e.querySelector(`button`);t instanceof HTMLElement&&t.click()}},x={render:e=>{let[t,n]=(0,f.useState)(null);return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Coverage period`,description:`Select the start and end dates for the report`}},S={render:e=>{let[t,n]=(0,f.useState)(null);return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Booking dates`,min:`2026-03-01`,max:`2026-06-30`,description:`Available: Mar 1 – Jun 30, 2026`}},C={render:e=>{let[t,n]=(0,f.useState)(null);return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Reporting period`,maxRangeSpan:7,description:`Pick a start date, then any end within a 7-day window`}},w={render:e=>{let[t,n]=(0,f.useState)(null);return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Stay`,minRangeSpan:2,maxRangeSpan:30,description:`At least 2 and at most 30 days`}},T={render:e=>{let[t,n]=(0,f.useState)(null);return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Filter by date`,isOptional:!0}},E={render:e=>{let[t,n]=(0,f.useState)(null);return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Coverage period`,isRequired:!0}},D={render:e=>{let[t,n]=(0,f.useState)({start:`2026-03-10`,end:`2026-03-20`});return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Locked range`,isDisabled:!0}},O={render:e=>{let[t,n]=(0,f.useState)(null);return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Reporting period`,isDisabled:!0,disabledMessage:`You need the Editor role to change this`}},k={render:()=>{let[e,t]=(0,f.useState)(null),[n,r]=(0,f.useState)(null),[i,a]=(0,f.useState)(null);return(0,p.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`16px`,maxWidth:`340px`},children:[(0,p.jsx)(s,{label:`Small (28px)`,value:e,onChange:t,size:`sm`}),(0,p.jsx)(s,{label:`Medium (32px)`,value:n,onChange:r,size:`md`}),(0,p.jsx)(s,{label:`Large (36px)`,value:i,onChange:a,size:`lg`})]})}},A={render:e=>{let[t,n]=(0,f.useState)(null);return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Date range`,numberOfMonths:1}},j={render:e=>{let[t,n]=(0,f.useState)(null);return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Date range`,status:{type:`error`,message:`Please select a date range`}}},M={render:e=>{let[t,n]=(0,f.useState)({start:`2026-03-01`,end:`2026-06-30`});return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Date range`,status:{type:`warning`,message:`Range exceeds 90 days`}}},N={render:e=>{let[t,n]=(0,f.useState)({start:`2026-03-10`,end:`2026-03-20`});return(0,p.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Required range`,hasClear:!1}},P={render:()=>{let[e,t]=(0,f.useState)(null),[n,r]=(0,f.useState)({start:`2026-03-10`,end:`2026-03-20`}),[i,a]=(0,f.useState)(null),[o,c]=(0,f.useState)({start:`2026-03-10`,end:`2026-03-20`}),[l,u]=(0,f.useState)(null);return(0,p.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`16px`,maxWidth:`340px`},children:[(0,p.jsx)(s,{label:`Default`,value:e,onChange:t}),(0,p.jsx)(s,{label:`With value`,value:n,onChange:r}),(0,p.jsx)(s,{label:`With presets`,value:i,onChange:a,presets:m}),(0,p.jsx)(s,{label:`Disabled`,isDisabled:!0,value:o,onChange:c}),(0,p.jsx)(s,{label:`With error`,value:l,onChange:u,status:{type:`error`,message:`Date range is required`}})]})}},F={render:()=>{let[e,t]=(0,f.useState)(null),[n,r]=(0,f.useState)(null);return(0,p.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:24,width:320},children:[(0,p.jsx)(s,{label:`Attached (default)`,value:e,onChange:t,status:{type:`error`,message:`Please select a date range`}}),(0,p.jsx)(s,{label:`Detached`,value:n,onChange:r,status:{type:`error`,message:`Please select a date range`},statusVariant:`detached`})]})}},I=i({name:`date-range-input-icon-demo`,components:{"input-clear-icon":{base:{width:`12px`,height:`12px`,fontSize:`12px`,color:`var(--color-icon-secondary)`,":hover":{color:`var(--color-accent)`}}},"date-range-input-toggle-icon":{base:{width:`14px`,height:`14px`,fontSize:`14px`,color:`var(--color-accent)`}}}}),L={render:()=>{let[e,t]=(0,f.useState)({start:l(7),end:u()});return(0,p.jsx)(o,{theme:I,mode:`light`,children:(0,p.jsx)(`div`,{style:{width:320},children:(0,p.jsx)(s,{label:`Icons themed (12px clear w/ hover, 14px accent toggle)`,value:e,onChange:t,hasClear:!0})})})}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  render: args => {
...
}`,...L.parameters?.docs?.source}}},R=[`Default`,`WithValue`,`WithPresets`,`WithPresetsAndValue`,`WithDisabledPresets`,`WithDescription`,`WithMinMax`,`MaxRangeSpan`,`RangeSpanBounds`,`Optional`,`Required`,`Disabled`,`DisabledWithMessage`,`SizeVariants`,`SingleMonth`,`WithErrorStatus`,`WithWarningStatus`,`NoClear`,`AllVariations`,`StatusVariantComparison`,`ThemedIcons`]}))();export{P as AllVariations,g as Default,D as Disabled,O as DisabledWithMessage,C as MaxRangeSpan,N as NoClear,T as Optional,w as RangeSpanBounds,E as Required,A as SingleMonth,k as SizeVariants,F as StatusVariantComparison,L as ThemedIcons,x as WithDescription,b as WithDisabledPresets,j as WithErrorStatus,S as WithMinMax,v as WithPresets,y as WithPresetsAndValue,_ as WithValue,M as WithWarningStatus,R as __namedExportsOrder,h as default};