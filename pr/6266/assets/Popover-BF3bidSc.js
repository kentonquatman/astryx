...
@default "Close popover"`},hasAutoFocus:{required:!1,tsType:{name:`boolean`},description:`Whether to move focus into the popover when it opens. Focus enters the
