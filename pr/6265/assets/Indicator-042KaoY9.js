...
@default false`,defaultValue:{value:`false`,computed:!1}},children:{required:!1,tsType:{name:`ReactNode`},description:`Content rendered inside the indicator chrome *instead of* the state mark.
CheckboxInput uses this to show a loading Spinner inside the box while a
change action is pending.`}},composes:[`Omit`]}}));function M(e){return e==null?null:typeof e==`string`?d(e):e}function N(e){return M(e)?.indicators??null}function P(e,t){return N(t)?.[e]??F[e]}var F,I=e((()=>{l(),b(),T(),j(),F={check:x,checkbox:m,radio:E}}));function L(e){return P(e,c())}var R=e((()=>{u(),I()})),z,B=e((()=>{z={astryx1odsvnm:`astryx1odsvnm`,$$css:!0}})),V=e((()=>{b(),T(),j(),I(),R(),B()}));export{L as a,x as c,b as d,R as i,T as l,z as n,E as o,B as r,j as s,V as t,m as u};