const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Tooltip-BzfOrCRr.js","./preload-helper-CT_b8DTk.js","./react-B7Te67-h.js","./jsx-runtime-DqZldVDK.js","./useTooltip-JTChjXN7.js","./ime-Dy4QRKoo.js","./padding.stylex-Hr1weLfK.js","./react-dom-Ctsxo5CR.js","./useIsomorphicLayoutEffect-AEBSTB0m.js"])))=>i.map(i=>d[i]);
import{i as e,n as t,s as n,t as r}from"./preload-helper-CT_b8DTk.js";import{t as i}from"./react-B7Te67-h.js";import{D as a,E as o,F as s,P as c}from"./ime-Dy4QRKoo.js";import{P as l,t as u}from"./utils-eYNPhPe_.js";import{t as d}from"./jsx-runtime-DqZldVDK.js";import{_ as f,a as p,c as m,d as h,f as g,g as _,h as v,i as y,l as b,m as x,n as S,o as C,p as w,r as T,s as E,u as D,v as O}from"./Text-CK2wkp3h.js";import{n as k,t as A}from"./useMergedRefs-BMVAJ2uJ.js";function j(e){return e===`display-1`||e===`display-2`||e===`display-3`}function M({level:e,type:t,accessibilityLevel:n,color:r=`primary`,display:i=`block`,maxLines:o=0,hasTruncateTooltip:c=!0,wordBreak:u,textWrap:d,justify:h=`start`,hasCapsize:y=!1,hasStrikethrough:S=!1,xstyle:A,className:M,style:L,children:R,ref:z,...B}){let V=I[e],H=n&&n!==e?{"aria-level":n}:{},U=u??(o===1?`break-all`:`break-word`),W=o>0||y?`block`:i,G=t&&j(t)?t:void 0,K=p({maxLines:o}),q=typeof c==`string`?c:`above`,J=o>0&&c!==!1&&K.isTruncated,Y=(0,N.useRef)(null),X=k(z,K.ref,Y),Z=o>1?{WebkitLineClamp:o}:void 0;return(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(V,{ref:X,...l(a(`heading`,{level:e,color:r,type:t}),s(E[T(r)],G?x[G]:w[e],G&&b[G],o===1?_.singleLine:o>1?_.multiLine:D[W],o>0&&O[U],d&&v[d],h!==`start`&&g[h],y&&C.enabled,S&&m.strikethrough,A),M,{...L,...Z}),...H,...B,children:R}),J&&(0,P.jsx)(N.Suspense,{fallback:null,children:(0,P.jsx)(F,{anchorRef:Y,content:(0,P.jsx)(`span`,{...s(f.content),children:K.fullText}),placement:q})})]})}var N,P,F,I,L=e((()=>{N=n(i(),1),c(),h(),y(),S(),u(),A(),o(),P=d(),t(),F=(0,N.lazy)(async()=>r(()=>import(`./Tooltip-BzfOrCRr.js`).then(e=>(e.r(),e.n)).then(e=>({default:e.Tooltip})),__vite__mapDeps([0,1,2,3,4,5,6,7,8]),import.meta.url)),I={1:`h1`,2:`h2`,3:`h3`,4:`h4`,5:`h5`,6:`h6`},M.displayName=`Heading`,M.__docgenInfo={description:`Heading - Semantic heading component
...
@default false`,defaultValue:{value:`false`,computed:!1}},children:{required:!0,tsType:{name:`ReactNode`},description:`Heading content`}},composes:[`Omit`]}}));export{L as n,M as t};