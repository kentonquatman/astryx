import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{t as i}from"./Card-CzeYGwY2.js";import{t as a}from"./Card-CfHLvAaN.js";import{i as o,t as s}from"./List-CGALxfJQ.js";import{r as c,t as l}from"./CheckboxListItem-lqVX8s5p.js";import{fr as u}from"./iframe-DEEdj1HO.js";var d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A;e((()=>{d=t(n()),u(),s(),a(),f=r(),p={title:`Core/CheckboxList`,component:c,tags:[`autodocs`],argTypes:{label:{control:`text`,description:`Label text (required)`},isLabelHidden:{control:`boolean`,description:`Visually hide the label (still accessible to screen readers)`},description:{control:`text`,description:`Description text displayed below the label`},density:{control:`select`,options:[`compact`,`balanced`,`spacious`],description:`Spacing density for list items`},hasDividers:{control:`boolean`,description:`Whether to show dividers between items`},isDisabled:{control:`boolean`,description:`Whether all checkbox items are disabled`},disabledMessage:{control:`text`,description:`Explains why the group is disabled (whole-group state, not per item). With isDisabled, shows a tooltip on hover/keyboard focus and keeps the checkboxes focusable via aria-disabled (toggling stays blocked). Use this instead of wrapping a disabled CheckboxList in Tooltip.`}}},m={render:e=>{let[t,n]=(0,d.useState)(e.value??[]),{value:r,onChange:i,...a}=e;return(0,f.jsxs)(c,{...a,value:t,onChange:n,children:[(0,f.jsx)(l,{label:`Email`,value:`email`}),(0,f.jsx)(l,{label:`SMS`,value:`sms`}),(0,f.jsx)(l,{label:`Push notification`,value:`push`})]})},args:{label:`Notification preferences`}},h={render:e=>{let[t,n]=(0,d.useState)(e.value??[]),{value:r,onChange:i,...a}=e;return(0,f.jsxs)(c,{...a,value:t,onChange:n,children:[(0,f.jsx)(l,{label:`Email`,value:`email`,description:`Receive notifications via email`}),(0,f.jsx)(l,{label:`SMS`,value:`sms`,description:`Standard messaging rates apply`}),(0,f.jsx)(l,{label:`Push notification`,value:`push`,description:`Instant alerts on your device`})]})},args:{label:`Notification preferences`,description:`Choose how you would like to be notified`,hasDividers:!0}},g={render:e=>{let t=[{id:`react`,label:`React`},{id:`vue`,label:`Vue`},{id:`angular`,label:`Angular`},{id:`svelte`,label:`Svelte`}],[n,r]=(0,d.useState)([`react`]),{value:i,onChange:a,...o}=e;return(0,f.jsx)(c,{...o,value:n,onChange:r,children:t.map(e=>(0,f.jsx)(l,{label:e.label,value:e.id},e.id))})},args:{label:`Frameworks`}},_={render:()=>{let[e,t]=(0,d.useState)(!1),[n,r]=(0,d.useState)(!0),[i,a]=(0,d.useState)(!1);return(0,f.jsxs)(o,{children:[(0,f.jsx)(l,{label:`Accept terms and conditions`,isChecked:e,onCheck:t}),(0,f.jsx)(l,{label:`Subscribe to newsletter`,description:`Weekly updates about new features`,isChecked:n,onCheck:r}),(0,f.jsx)(l,{label:`Receive marketing emails`,isChecked:i,onCheck:a})]})}},v={render:()=>(0,f.jsxs)(o,{children:[(0,f.jsx)(l,{label:`Completed task`,isChecked:!0}),(0,f.jsx)(l,{label:`Pending task`,isChecked:!1}),(0,f.jsx)(l,{label:`In progress`,isChecked:`indeterminate`})]})},y={render:()=>{let e=[`email`,`sms`,`push`],[t,n]=(0,d.useState)([`email`]),r=e.every(e=>t.includes(e)),i=t.length===0,a=r?!0:i?!1:`indeterminate`;return(0,f.jsxs)(c,{label:`Notifications`,hasDividers:!0,children:[(0,f.jsx)(l,{label:`Select all`,isChecked:a,onCheck:t=>{n(t?[...e]:[])}}),e.map(e=>(0,f.jsx)(l,{label:e.charAt(0).toUpperCase()+e.slice(1),isChecked:t.includes(e),onCheck:t=>{n(n=>t?[...n,e]:n.filter(t=>t!==e))}},e))]})}},b={render:e=>{let[t,n]=(0,d.useState)([`email`]),{value:r,onChange:i,...a}=e;return(0,f.jsxs)(c,{...a,value:t,onChange:n,children:[(0,f.jsx)(l,{label:`Email`,value:`email`}),(0,f.jsx)(l,{label:`SMS`,value:`sms`}),(0,f.jsx)(l,{label:`Push notification`,value:`push`})]})},args:{label:`Notification preferences`,isDisabled:!0}},x={render:()=>{let[e,t]=(0,d.useState)([`email`]);return(0,f.jsxs)(c,{label:`Notification preferences`,value:e,onChange:t,children:[(0,f.jsx)(l,{label:`Email`,value:`email`}),(0,f.jsx)(l,{label:`SMS`,value:`sms`,isLoading:!0}),(0,f.jsx)(l,{label:`Push notification`,value:`push`})]})}},S={render:()=>{let[e,t]=(0,d.useState)([`email`]);return(0,f.jsxs)(c,{label:`Notification preferences`,description:`Toggle an option — it spins while saving`,value:e,changeAction:e=>new Promise(n=>{setTimeout(()=>{t(e),n()},1500)}),hasDividers:!0,children:[(0,f.jsx)(l,{label:`Email`,value:`email`}),(0,f.jsx)(l,{label:`SMS`,value:`sms`}),(0,f.jsx)(l,{label:`Push notification`,value:`push`})]})}},C={render:e=>{let[t,n]=(0,d.useState)([]),{value:r,onChange:i,...a}=e;return(0,f.jsxs)(c,{...a,value:t,onChange:n,children:[(0,f.jsx)(l,{label:`Email`,value:`email`}),(0,f.jsx)(l,{label:`SMS`,value:`sms`,isDisabled:!0}),(0,f.jsx)(l,{label:`Push notification`,value:`push`})]})},args:{label:`Notification preferences`}},w={render:e=>{let[t,n]=(0,d.useState)([]),{value:r,onChange:i,...a}=e;return(0,f.jsxs)(c,{...a,value:t,onChange:n,children:[(0,f.jsx)(l,{label:`Email`,value:`email`}),(0,f.jsx)(l,{label:`SMS`,value:`sms`}),(0,f.jsx)(l,{label:`Push notification`,value:`push`})]})},args:{label:`Notification preferences`,status:{type:`error`,message:`Please select at least one notification method`}}},T={render:e=>{let[t,n]=(0,d.useState)([`free`]),{value:r,onChange:i,...a}=e;return(0,f.jsxs)(c,{...a,value:t,onChange:n,children:[(0,f.jsx)(l,{label:`Free tier`,value:`free`,description:`Basic features included`,endContent:(0,f.jsx)(`span`,{style:{color:`#0D8626`},children:`$0/mo`})}),(0,f.jsx)(l,{label:`Pro tier`,value:`pro`,description:`Advanced features`,endContent:(0,f.jsx)(`span`,{style:{color:`#0064E0`},children:`$9/mo`})}),(0,f.jsx)(l,{label:`Enterprise`,value:`enterprise`,description:`Custom solutions`,endContent:(0,f.jsx)(`span`,{style:{color:`#5B08D8`},children:`Custom`})})]})},args:{label:`Add-on packages`,hasDividers:!0}},E={render:()=>{let[e,t]=(0,d.useState)([]),[n,r]=(0,d.useState)([`email`]),[i,a]=(0,d.useState)(!1),[s,u]=(0,d.useState)(!0);return(0,f.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`24px`,maxWidth:`400px`},children:[(0,f.jsxs)(c,{label:`Unselected`,value:e,onChange:t,children:[(0,f.jsx)(l,{label:`Option A`,value:`a`}),(0,f.jsx)(l,{label:`Option B`,value:`b`})]}),(0,f.jsxs)(c,{label:`Pre-selected`,value:n,onChange:r,children:[(0,f.jsx)(l,{label:`Email`,value:`email`}),(0,f.jsx)(l,{label:`SMS`,value:`sms`})]}),(0,f.jsxs)(c,{label:`Disabled group`,value:[`a`],onChange:()=>{},isDisabled:!0,children:[(0,f.jsx)(l,{label:`Option A`,value:`a`}),(0,f.jsx)(l,{label:`Option B`,value:`b`})]}),(0,f.jsxs)(c,{label:`With descriptions`,value:e,onChange:t,hasDividers:!0,children:[(0,f.jsx)(l,{label:`Email`,value:`email`,description:`Delivered to your inbox`}),(0,f.jsx)(l,{label:`SMS`,value:`sms`,description:`Standard rates apply`})]}),(0,f.jsxs)(c,{label:`With error`,value:[],onChange:()=>{},status:{type:`error`,message:`Please select at least one option`},children:[(0,f.jsx)(l,{label:`Option A`,value:`a`}),(0,f.jsx)(l,{label:`Option B`,value:`b`})]}),(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`h4`,{style:{margin:`0 0 8px`},children:`Standalone mode`}),(0,f.jsxs)(o,{children:[(0,f.jsx)(l,{label:`Accept terms`,isChecked:i,onCheck:a}),(0,f.jsx)(l,{label:`Subscribe`,isChecked:s,onCheck:u})]})]})]})}},D={render(){let[e,t]=(0,d.useState)([`email`]);return(0,f.jsx)(`div`,{style:{maxWidth:400},children:(0,f.jsx)(i,{children:(0,f.jsxs)(c,{label:`Notifications`,description:`Choose how to be notified`,value:e,onChange:t,children:[(0,f.jsx)(l,{value:`email`,label:`Email`,description:`Weekly digest`}),(0,f.jsx)(l,{value:`push`,label:`Push notifications`}),(0,f.jsx)(l,{value:`sms`,label:`SMS`,isDisabled:!0})]})})})}},O={render(){let[e,t]=(0,d.useState)([`admin`]);return(0,f.jsx)(`div`,{style:{maxWidth:400},children:(0,f.jsx)(i,{children:(0,f.jsxs)(c,{label:`Assign Roles`,value:e,onChange:t,hasDividers:!0,children:[(0,f.jsx)(l,{value:`admin`,label:`Admin`}),(0,f.jsx)(l,{value:`editor`,label:`Editor`}),(0,f.jsx)(l,{value:`viewer`,label:`Viewer`}),(0,f.jsx)(l,{value:`guest`,label:`Guest`})]})})})}},k={render:e=>{let[t,n]=(0,d.useState)([`email`]),{value:r,onChange:i,...a}=e;return(0,f.jsxs)(c,{...a,value:t,onChange:n,children:[(0,f.jsx)(l,{label:`Email`,value:`email`}),(0,f.jsx)(l,{label:`SMS`,value:`sms`}),(0,f.jsx)(l,{label:`Push notification`,value:`push`})]})},args:{label:`Notification preferences`,isDisabled:!0,disabledMessage:`Notifications are managed by your administrator`}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  render: args => {
