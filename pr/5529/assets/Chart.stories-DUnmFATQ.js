import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{t as i}from"./Text-z8muYPH2.js";import{c as a}from"./Stack-B9pi7ZUb.js";import{u as o}from"./iframe-DEEdj1HO.js";import{$ as s,Et as c,Ot as l,St as u,bt as d,et as f,ft as p,nt as m,ot as h,t as g,ut as _,vt as v,wt as y}from"./src-BDrW0YBf.js";import{n as b,t as x}from"./useDataset-D0R9TzHE.js";var S,C,w,T,E,D,O,k,A,j;e((()=>{S=t(n()),g(),o(),x(),C=r(),w={title:`Lab/Chart`,component:l,tags:[`autodocs`],parameters:{docs:{description:{component:`\`Chart\` — composable chart system built on d3. All marks share a single
coordinate space via React context.

Datasets from [vega-datasets](https://github.com/vega/vega-datasets) (CDN).`}}}},T={render:()=>{let e=s(),[t,n]=b(`barley.json`),r=(0,S.useMemo)(()=>{if(!t.length)return[];let e=new Map;for(let n of t){let t=e.get(n.variety)??{sum:0,count:0};t.sum+=n.yield,t.count+=1,e.set(n.variety,t)}return[...e.entries()].map(([e,{sum:t,count:n}])=>({variety:e,avgYield:Math.round(t/n*10)/10})).sort((e,t)=>t.avgYield-e.avgYield).slice(0,10)},[t]);return n?(0,C.jsx)(i,{type:`supporting`,children:`Loading…`}):(0,C.jsxs)(l,{data:r,xKey:`variety`,yKeys:[`avgYield`],height:300,children:[(0,C.jsx)(y,{horizontal:!0}),(0,C.jsx)(c,{position:`bottom`}),(0,C.jsx)(c,{position:`left`}),(0,C.jsx)(u,{dataKey:`avgYield`,color:e.categorical(1)[0]}),(0,C.jsx)(m,{})]})}},E={render:()=>{let e=s(),[t,n]=b(`stocks.csv`),r=(0,S.useMemo)(()=>{if(!t.length)return[];let e=t.filter(e=>e.symbol===`AAPL`||e.symbol===`GOOG`),n=new Map;for(let t of e){let e=n.get(t.date)??{date:t.date};e[t.symbol]=t.price,n.set(t.date,e)}return[...n.values()].filter(e=>e.AAPL!=null&&e.GOOG!=null).slice(-12)},[t]);if(n)return(0,C.jsx)(i,{type:`supporting`,children:`Loading…`});let a=e.categorical(2);return(0,C.jsxs)(l,{data:r,xKey:`date`,yKeys:[`AAPL`,`GOOG`],yBaseline:`data`,height:300,children:[(0,C.jsx)(y,{horizontal:!0}),(0,C.jsx)(c,{position:`bottom`}),(0,C.jsx)(c,{position:`left`}),(0,C.jsx)(d,{dataKey:`AAPL`,color:a[0],dots:!0}),(0,C.jsx)(d,{dataKey:`GOOG`,color:a[1],dots:!0}),(0,C.jsx)(f,{items:[{label:`AAPL`,color:a[0]},{label:`GOOG`,color:a[1]}]}),(0,C.jsx)(m,{})]})}},D={render:()=>{let e=s(),[t,n]=b(`cars.json`),r=(0,S.useMemo)(()=>t.filter(e=>e.Horsepower!=null&&e.Miles_per_Gallon!=null).map(e=>({hp:e.Horsepower,mpg:e.Miles_per_Gallon})),[t]);return n?(0,C.jsx)(i,{type:`supporting`,children:`Loading…`}):(0,C.jsxs)(l,{data:r,xKey:`hp`,yKeys:[`mpg`],yBaseline:`data`,height:350,children:[(0,C.jsx)(y,{horizontal:!0,vertical:!0}),(0,C.jsx)(c,{position:`bottom`}),(0,C.jsx)(c,{position:`left`}),(0,C.jsx)(p,{dataKey:`mpg`,color:e.categorical(1)[0],radius:3}),(0,C.jsx)(m,{crosshair:`xy`})]})}},O={render:()=>{let e=s(),[t,n]=b(`flights-10k.json`),r=(0,S.useMemo)(()=>t.filter(e=>e.delay!=null&&e.distance!=null).map(e=>({distance:e.distance,delay:e.delay})),[t]);return n?(0,C.jsx)(i,{type:`supporting`,children:`Loading 10k flights…`}):(0,C.jsxs)(a,{direction:`vertical`,gap:2,children:[(0,C.jsxs)(i,{type:`supporting`,color:`secondary`,children:[r.length.toLocaleString(),` flights`]}),(0,C.jsxs)(l,{data:r,xKey:`distance`,yKeys:[`delay`],yBaseline:`zero`,height:400,children:[(0,C.jsx)(y,{horizontal:!0}),(0,C.jsx)(c,{position:`bottom`}),(0,C.jsx)(c,{position:`left`}),(0,C.jsx)(_,{dataKey:`delay`,color:e.categorical(1)[0],size:3,opacity:.3})]})]})}},k={render:()=>{let e=s(),[t,n]=b(`seattle-weather.csv`),r=(0,S.useMemo)(()=>{if(!t.length)return[];let e=new Map;for(let n of t){let t=String(n.date).slice(0,7),r=e.get(t)??{maxSum:0,minSum:0,count:0};r.maxSum+=n.temp_max,r.minSum+=n.temp_min,r.count+=1,e.set(t,r)}return[...e.entries()].map(([e,{maxSum:t,minSum:n,count:r}])=>({month:e,avgMax:Math.round(t/r*10)/10,avgMin:Math.round(n/r*10)/10,avgMid:Math.round((t+n)/(r*2)*10)/10})).sort((e,t)=>e.month.localeCompare(t.month)).slice(-24)},[t]);return n?(0,C.jsx)(i,{type:`supporting`,children:`Loading…`}):(0,C.jsxs)(l,{data:r,xKey:`month`,yKeys:[`avgMax`,`avgMin`],yBaseline:`data`,height:300,children:[(0,C.jsx)(y,{horizontal:!0}),(0,C.jsx)(c,{position:`bottom`}),(0,C.jsx)(c,{position:`left`}),(0,C.jsx)(v,{yUpper:`avgMax`,yLower:`avgMin`,color:e.categorical(1)[0],opacity:.15}),(0,C.jsx)(d,{dataKey:`avgMid`,color:e.categorical(1)[0],dots:!0}),(0,C.jsx)(m,{})]})}},A={render:()=>{let e=s(),[t,n]=b(`gapminder.json`),r=(0,S.useMemo)(()=>{if(!t.length)return[];let e=[`United States`,`China`,`India`,`Brazil`,`Japan`,`Germany`,`Nigeria`,`Russia`];return t.filter(t=>e.includes(t.country)&&t.year>=1960&&t.year%10==0).map(e=>({country:e.country,year:String(e.year),lifeExp:Math.round(e.life_expect)}))},[t]);return n?(0,C.jsx)(i,{type:`supporting`,children:`Loading…`}):(0,C.jsxs)(l,{data:r,xKey:`year`,yKeys:[`lifeExp`],height:300,children:[(0,C.jsx)(c,{position:`bottom`}),(0,C.jsx)(h,{xKey:`year`,yKey:`country`,valueKey:`lifeExp`,colorRange:e.sequential.blue(5)}),(0,C.jsx)(f,{gradient:e.sequential.blue(5),domain:[30,85],label:`Life Expectancy`})]})}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  render: () => {
