...
// Astryx's own touch picker instead of the platform's
<DateInput label="Event date" value={date} onChange={setDate} nativePicker="never" />
\`\`\``}},composes:[`Omit`]}}));function q({label:e,isLabelHidden:t=!1,description:n,isOptional:te=!1,isRequired:i=!1,isDisabled:a=!1,disabledMessage:o,value:s,onChange:c,changeAction:l,isLoading:se=!1,min:le,max:fe,dateConstraints:u,placeholder:pe,size:me,status:d,statusVariant:ye=`attached`,labelTooltip:f,hasClear:p=!1,numberOfMonths:Se=1,weekStartsOn:we,format:Te=`date_long`,width:Ee,xstyle:ke,className:Ae,style:m,ref:je,...h}){let g=De(),_=Oe(),Pe=Ke({isRequired:i,isOptional:te}),Fe=pe??g(`@astryx.dateInput.placeholder`),Ie=Ce(me,`md`),Le=(0,Y.useId)(),y=(0,Y.useId)(),b=(0,Y.useId)(),Re=(0,Y.useId)(),x=(0,Y.useRef)(null),C=(0,Y.useRef)(null),w=(0,Y.useRef)(void 0),T=Ye(),[,E]=(0,Y.useTransition)(),[D,Je]=(0,Y.useOptimistic)(s),O=se||D!==s,k=a||O,A=a&&!!o,j=_e({placement:`above`,focusTrigger:`always`,isEnabled:A}),{isDateDisabled:M}=ze({min:le,max:fe,dateConstraints:u}),{statusIcon:Xe,describedBy:Ze}=Ne({status:d,statusVariant:ye,isInGroup:!!T}),{ariaLabelledBy:N,ariaDescribedBy:P}=ge(y,[n?b:null,ye!==`tooltip`&&d?.message?Re:null,Ze,A?j.describedBy:null],T),[F,I]=(0,Y.useState)(null),L=(0,Y.useRef)(s);s!==L.current&&(L.current=s,s!==w.current&&(w.current=void 0,F!==null&&I(null)));let Qe=(0,Y.useCallback)(e=>typeof Te==`function`?Te(e):de(he(e),Te,_),[Te,_]),$e=F===null?D&&/^\d{4}-\d{2}-\d{2}$/.test(D)?Qe(D):``:F,R=F===null||!F.trim()?!0:oe(F,_)!==null,z=v({dialogLabel:g(`@astryx.dateInput.dialogLabel`),closeButtonLabel:g(`@astryx.dateInput.closeCalendar`),onHide:()=>{ce()&&x.current?.focus()}}),B=(0,Y.useCallback)(()=>{k||(z.isOpen?z.hide():z.show())},[k,z]),et=(0,Y.useCallback)(()=>{!k&&!z.isOpen&&z.show({skipAutoFocus:!0})},[k,z]),V=(0,Y.useCallback)(e=>{O||(c?.(e),l&&E(async()=>{Je(e),await l(e)}))},[O,c,l,E,Je]),tt=(0,Y.useCallback)(()=>{V(void 0),x.current?.focus()},[V]),H=(0,Y.useCallback)(e=>{V(e),I(null),z.hide()},[V,z]),U=(0,Y.useCallback)(e=>{if(k)return;let t=e.target.value;I(t);let n=oe(t,_);if(n&&ue(n)!==s&&!M(n)){let e=ue(n);w.current=e,V(e),C.current?.navigateTo(e)}},[s,V,M,k,_]),W=(0,Y.useCallback)(()=>{if(F===null)return;if(!F.trim()){s!==void 0&&V(void 0),I(null);return}let e=oe(F,_);if(e&&!M(e)){let t=ue(e);t!==s&&V(t)}I(null)},[F,s,V,M,_]),G=(0,Y.useCallback)(()=>{W()},[W]),nt=(0,Y.useCallback)(e=>{re(e.nativeEvent)||(e.key===`Escape`&&z.isOpen?(e.preventDefault(),z.hide()):(e.key===`ArrowDown`||e.altKey&&e.key===`ArrowDown`)&&!z.isOpen?(e.preventDefault(),k||z.show({skipAutoFocus:!0})):e.key===`Enter`&&(e.preventDefault(),W()))},[z,W,k]),K=(0,X.jsxs)(`div`,{ref:e=>{z.triggerRef(e),j.ref(e)},...h,...ie(ee(`date-input`,{size:Ie,status:d?.type??null,disabled:a?`disabled`:null}),r(He.base,Z[Ie],k&&He.disabled,d&&We[d.type],d&&!k&&Ve[d.type],d&&Ge[d.type],T&&qe.inGroup,ke),Ae,m),children:[T&&(0,X.jsx)(xe,{id:y,children:e}),(0,X.jsx)(`button`,{type:`button`,onClick:B,disabled:k,"aria-label":z.isOpen?g(`@astryx.dateInput.toggleCalendarClose`):g(`@astryx.dateInput.openCalendar`),...r(ae.focusVisible,it.iconButton,k&&it.iconButtonDisabled),children:(0,X.jsx)(Me,{icon:`calendar`,size:`sm`,color:`secondary`,...ee(`date-input-toggle-icon`,{state:z.isOpen?`expanded`:`collapsed`})})}),(0,X.jsx)(`input`,{ref:ve(je,x),id:Le,type:`text`,role:`combobox`,value:$e,onChange:U,onBlur:G,onClick:et,onKeyDown:nt,placeholder:Fe,disabled:k&&!A,"aria-disabled":A?`true`:void 0,readOnly:A||void 0,"aria-labelledby":N,"aria-describedby":P,"aria-required":Pe?`true`:void 0,"aria-invalid":d?.type===`error`||!R?`true`:void 0,"aria-busy":O||void 0,"aria-expanded":z.isOpen,"aria-haspopup":`dialog`,"aria-controls":z.isOpen?z.id:void 0,"aria-autocomplete":`none`,autoComplete:`off`,...{0:{className:`astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxjbqb8w astryx1a2a7pz astryxeyghm5`},2:{className:`astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryxt0e3qv`},1:{className:`astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryxv1l7n4`},3:{className:`astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryxt0e3qv astryxv1l7n4`}}[!!k<<1|!R<<0]}),(0,X.jsx)(xe,{as:`div`,role:`alert`,"aria-live":`assertive`,children:R?``:g(`@astryx.dateInput.invalidDate`)}),p&&s!==void 0&&!k&&(0,X.jsx)(Ue,{label:g(`@astryx.dateInput.clear`,{label:e}),onClick:tt,iconClassName:ne(`date-input-clear-icon`)}),O&&(0,X.jsx)(be,{size:`sm`}),Xe,z.render((0,X.jsx)(S,{handleRef:C,mode:`single`,value:D,onChange:H,min:le,max:fe,dateConstraints:u,numberOfMonths:Se,weekStartsOn:we}),{placement:`below`,alignment:`start`}),A&&j.renderTooltip(o)]});return T?K:(0,X.jsx)(Be,{label:e,isLabelHidden:t,description:n,inputID:Le,descriptionID:n?b:void 0,isOptional:te,isRequired:i,isDisabled:a,status:d?{type:d.type,message:d.message,messageID:d.message?Re:void 0}:void 0,statusVariant:ye,labelTooltip:f,width:Ee,children:K})}function J(e){let t=je(Q),n=e.nativePicker??`touch`;return n===`always`||n===`touch`&&t?(0,X.jsx)(R,{...e}):t?(0,X.jsx)(U,{...e}):(0,X.jsx)(q,{...e})}var Y,X,it,Z,Q,$=e((()=>{Y=t(n(),1),a(),T(),h(),p(),Je(),D(),Se(),f(),w(),C(),g(),m(),E(),b(),H(),rt(),Pe(),me(),se(),X=d(),te(),fe(),i(),ke(),ye(),it={iconButton:{k1xSpc:`astryx78zum5`,kGNEyG:`astryx6s0dn4`,kjj79g:`astryxl56j7k`,kmVPX3:`astryx1717udv`,kg3NbH:null,kuDDbn:null,kE3dHu:null,kP0aTx:null,kpe85a:null,k8WAf4:null,kLKAdn:null,kGO01o:null,kogj98:`astryx1ghz6dp`,kUOVxO:null,keTefX:null,koQZXg:null,k71WvV:null,km5ZXQ:null,kqGvvJ:null,keoZOQ:null,k1K539:null,kMzoRj:`astryxc342km`,kjGldf:null,k2ei4v:null,kZ1KPB:null,ke9TFa:null,kWqL5O:null,kLoX6v:null,kEafiO:null,kt9PQ7:null,ksu8eU:`astryxng3xce`,kJRH4f:null,kVhnKS:null,k4WBpm:null,k8ry5P:null,kSWEuD:null,kDUl1X:null,kPef9Z:null,kfdmCh:null,kWkggS:`astryxjbqb8w`,kkrTdU:`astryx1ypdohk astryx16khyan`,kaIpWk:`astryxh6dtrn`,krdFHd:null,kfmiAY:null,kVL7Gh:null,kT0f0o:null,kIxVMA:null,ksF3WI:null,kqGeR4:null,kYm2EN:null,$$css:!0},iconButtonDisabled:{kkrTdU:`astryxt0e3qv`,$$css:!0}},Z={sm:{kZKoxP:`astryx6k0iem`,k7Eaqz:`astryxfb3i0g`,$$css:!0},md:{kZKoxP:`astryx1ueg155`,k7Eaqz:`astryxfb3i0g`,$$css:!0},lg:{kZKoxP:`astryxssyfek`,k7Eaqz:`astryxfb3i0g`,$$css:!0}},Q=`(pointer: coarse)`,q.displayName=`PointerDateField`,J.displayName=`DateInput`,J.__docgenInfo={description:`A date picker that fits the pointer it is being used with.
