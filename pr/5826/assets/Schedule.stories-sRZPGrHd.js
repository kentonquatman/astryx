import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{$t as i,an as a,fn as o,ln as s,mn as c,rn as l,sn as u,t as d,tn as f}from"./src-9hrJ7FPH.js";function p(e,t){let n=new Date(e);return n.setDate(n.getDate()+t),n}function m(e){let t=new Date(e);return t.setHours(12,0,0,0),t.setDate(t.getDate()-t.getDay()),t}function h(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function g(e,t,n=0){let r=new Date(e);return r.setHours(t,n,0,0),r.toISOString()}function _(e){let t=e;return()=>(t=(t*1664525+1013904223)%4294967296,t/4294967296)}function v(e,t){let n=_(Math.floor(e/864e5)),r=w.slice(0,6),i=[`Planning sync`,`Design critique`,`Customer review`,`Metrics readout`,`Launch check`,`Office hours`],a=[];for(let o=e;o<t;o+=1440*60*1e3){let e=1+Math.floor(n()*3),t=new Date(o);for(let s=0;s<e;s++){let e=8+Math.floor(n()*8),c=n()>.65?30:0,l=1+Math.floor(n()*2),d=i[Math.floor(n()*i.length)],f=r[Math.floor(n()*r.length)];a.push(u({id:`${o}:${s}`,title:d,category:f.label,start:g(t,e,c),end:g(t,e+l,c)}))}n()>.68&&a.push(u({id:`${o}:all-day`,title:`Focus day`,category:r[Math.floor(n()*r.length)].label,start:h(t),end:h(t)}))}return a}var y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P;e((()=>{y=t(n()),d(),b=r(),x=new Date,S=x.getTime(),C=m(x),w=[{label:`Company`,color:`blue`},{label:`Design`,color:`purple`},{label:`Launch`,color:`green`},{label:`Focus`,color:`teal`},{label:`Holiday`,color:`yellow`},{label:`Retro`,color:`orange`},{label:`Incident`,color:`red`},{label:`Migration`,color:`pink`}],T=[u({id:`all-hands`,title:`Company all hands`,category:`Company`,start:g(x,9),end:g(x,10)}),u({id:`all-hands-previous-day`,title:`Company all hands`,category:`Company`,start:g(p(x,-1),9),end:g(p(x,-1),10)}),u({id:`all-hands-next-day`,title:`Company all hands`,category:`Company`,start:g(p(x,1),9),end:g(p(x,1),10)}),u({id:`design-review`,title:`Design review`,category:`Design`,start:g(x,11),end:g(x,12,30)}),u({id:`launch`,title:`Launch window`,category:`Launch`,start:h(p(C,3)),end:h(p(C,4))}),u({id:`focus-day`,title:`Focus day`,category:`Focus`,start:h(x),end:h(x)}),u({id:`company-holiday`,title:`Company holiday`,category:`Holiday`,start:h(p(C,6)),end:h(p(C,6))}),u({id:`retro`,title:`Weekly retro`,category:`Retro`,start:g(p(C,5),14),end:g(p(C,5),15)}),u({id:`incident`,title:`Incident review`,category:`Incident`,start:g(p(C,1),10,30),end:g(p(C,1),11,30)}),u({id:`overnight-migration`,title:`Overnight migration`,category:`Migration`,start:g(p(C,5),23,30),end:g(p(C,6),2)})],E={title:`Lab/Schedule`,component:s,tags:[`autodocs`],parameters:{layout:`fullscreen`},decorators:[e=>(0,b.jsx)(`div`,{style:{padding:24,minHeight:`100vh`},children:(0,b.jsx)(e,{})})]},D={render:()=>{let[e,t]=(0,y.useState)(S);return(0,b.jsx)(s,{view:(0,y.useMemo)(()=>a(),[]),events:T,categories:w,date:e,focusDate:S,onChangeDate:t,timezoneID:`America/Los_Angeles`})}},O={render:()=>{let[e,t]=(0,y.useState)(S);return(0,b.jsx)(s,{view:(0,y.useMemo)(()=>l({minHour:7,maxHour:19}),[]),events:T,categories:w,date:e,onChangeDate:t,timezoneID:`America/Los_Angeles`})}},k={render:()=>{let[e,t]=(0,y.useState)(S);return(0,b.jsx)(`div`,{style:{height:520},children:(0,b.jsx)(s,{view:(0,y.useMemo)(()=>l({minHour:7,maxHour:19}),[]),events:T,categories:w,date:e,onChangeDate:t,timezoneID:`America/Los_Angeles`,style:{height:`100%`}})})}},A={render:()=>{let[e,t]=(0,y.useState)(S);return(0,b.jsx)(s,{view:(0,y.useMemo)(()=>f(),[]),events:T,categories:w,date:e,focusDate:S,onChangeDate:t,timezoneID:`America/Los_Angeles`})}},j={render:()=>{let[e,t]=(0,y.useState)(S);return(0,b.jsx)(s,{view:(0,y.useMemo)(()=>i(),[]),events:T,categories:w,date:e,focusDate:S,onChangeDate:t,timezoneID:`America/Los_Angeles`})}},M={render:()=>{let[e,t]=(0,y.useState)(S),n=(0,y.useMemo)(()=>l({minHour:7,maxHour:19}),[]);return(0,b.jsx)(s,{view:n,events:async(e,t)=>(await new Promise(e=>setTimeout(e,300)),v(e,t)),categories:w,date:e,focusDate:S,onChangeDate:t,timezoneID:`America/Los_Angeles`})}},N={render:()=>{let e=(0,y.useMemo)(()=>({month:a(),week:l({minHour:7,maxHour:19}),day:f({minHour:8,maxHour:18}),list:i()}),[]),[t,n]=(0,y.useState)(()=>e.week),[r,u]=(0,y.useState)(S),d=(0,y.useMemo)(()=>[{view:e.month,label:`Month`},{view:e.week,label:`Week`},{view:e.day,label:`Day`},{view:e.list,label:`List`}],[e]),p=c(),m=o(d,{onChangeView:n}),h=(0,y.useMemo)(()=>[p,m],[p,m]);return(0,b.jsx)(s,{view:t,events:T,categories:w,date:r,focusDate:S,onChangeDate:u,timezoneID:`America/Los_Angeles`,plugins:h})}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  render: () => {
