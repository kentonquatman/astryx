import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{i}from"./columnUtils-ulRI5lEk.js";import{t as a}from"./Table-Q-pd7oGf.js";import{Jt as o,Xt as s,jt as c,ut as l}from"./iframe-Bo60kS4Q.js";var u,d,f,p,m,h,g,_,v,y,b,x,S;e((()=>{u=t(n()),l(),d=r(),f=[{id:`1`,name:`Alice`,email:`alice@example.com`,role:`Engineer`,isLocked:!1},{id:`2`,name:`Bob`,email:`bob@example.com`,role:`Designer`,isLocked:!1},{id:`3`,name:`Charlie`,email:`charlie@example.com`,role:`Manager`,isLocked:!1},{id:`4`,name:`Diana`,email:`diana@example.com`,role:`Engineer`,isLocked:!0},{id:`5`,name:`Eve`,email:`eve@example.com`,role:`Admin`,isLocked:!1}],p=[{key:`name`,header:`Name`},{key:`email`,header:`Email`},{key:`role`,header:`Role`}],m={title:`Core/TableColumnResize`,tags:[`autodocs`]},h={render:()=>{let[e,t]=(0,u.useState)({}),n=c({columnWidths:e,columns:p,onColumnResizeEnd:e=>{t(t=>({...t,...e}))}});return(0,d.jsxs)(`div`,{style:{maxWidth:600},children:[(0,d.jsx)(`p`,{style:{marginBottom:8,fontSize:14,color:`var(--color-text-secondary)`},children:`Drag the right edge of any column header to resize. The last proportional column has no handle; it flexes to fill remaining space.`}),(0,d.jsx)(a,{data:f,columns:p,idKey:`id`,plugins:{columnResize:n}})]})}},g={render:()=>{let[e,t]=(0,u.useState)({}),n=c({columnWidths:e,onColumnResizeEnd:e=>{t(t=>({...t,...e}))},columns:p,minWidth:80,maxWidth:300});return(0,d.jsxs)(`div`,{style:{maxWidth:600},children:[(0,d.jsx)(`p`,{style:{marginBottom:8,fontSize:14,color:`var(--color-text-secondary)`},children:`Columns are constrained between 80px and 300px.`}),(0,d.jsx)(a,{data:f,columns:p,idKey:`id`,plugins:{columnResize:n}})]})}},_={render:()=>{let[e,t]=(0,u.useState)({}),n=c({columnWidths:e,columns:p,onColumnResizeEnd:e=>{t(t=>({...t,...e}))}});return(0,d.jsxs)(`div`,{style:{maxWidth:600},children:[(0,d.jsxs)(`p`,{style:{marginBottom:8,fontSize:14,color:`var(--color-text-secondary)`},children:[`Current widths:`,` `,Object.keys(e).length>0?Object.entries(e).map(([e,t])=>`${e}: ${t}px`).join(`, `):`none set (resize a column to see)`]}),(0,d.jsx)(`button`,{onClick:()=>t({}),style:{marginBottom:8,fontSize:14},children:`Reset all widths`}),(0,d.jsx)(a,{data:f,columns:p,idKey:`id`,plugins:{columnResize:n}})]})}},v={render:()=>{let[e,t]=(0,u.useState)({}),n=c({columnWidths:e,columns:p,onColumnResizeEnd:e=>{t(t=>({...t,...e}))}});return(0,d.jsxs)(`div`,{style:{maxWidth:600},children:[(0,d.jsx)(`p`,{style:{marginBottom:8,fontSize:14,color:`var(--color-text-secondary)`},children:`Tab to a resize handle, press Enter to activate, use Arrow keys to resize (Shift for larger steps), Enter to commit, Escape to cancel.`}),(0,d.jsx)(a,{data:f,columns:p,idKey:`id`,plugins:{columnResize:n}})]})}},y={render:()=>{let[e,t]=(0,u.useState)(new Set),[n,r]=(0,u.useState)({}),{selectionConfig:i}=o({data:f,idKey:`id`,selectedKeys:e,setSelectedKeys:t}),l=s(i),m=c({columnWidths:n,columns:p,onColumnResizeEnd:e=>{r(t=>({...t,...e}))}});return(0,d.jsxs)(`div`,{style:{maxWidth:600},children:[(0,d.jsxs)(`p`,{style:{marginBottom:8,fontSize:14,color:`var(--color-text-secondary)`},children:[`Selection and column resize plugins composed together. Selected:`,` `,e.size,` of `,f.length]}),(0,d.jsx)(a,{data:f,columns:p,idKey:`id`,plugins:{selection:l,columnResize:m}})]})}},b=[{key:`name`,header:`Name`,width:i(200)},{key:`email`,header:`Email`,width:i(250)},{key:`role`,header:`Role`,width:i(150)}],x={render:()=>{let[e,t]=(0,u.useState)({}),n=c({columnWidths:e,columns:b,onColumnResizeEnd:e=>{t(t=>({...t,...e}))}});return(0,d.jsxs)(`div`,{style:{maxWidth:600},children:[(0,d.jsx)(`p`,{style:{marginBottom:8,fontSize:14,color:`var(--color-text-secondary)`},children:`All columns are pixel-width. Every column gets a resize handle, including the last one. Min width defaults to the column's declared pixel value.`}),(0,d.jsx)(a,{data:f,columns:b,idKey:`id`,plugins:{columnResize:n}})]})}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  render: () => {
