import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./jsx-runtime-DqZldVDK.js";import{Rn as n,Vn as r,zn as i}from"./iframe-Bo60kS4Q.js";import{An as a,Mt as o,O as s,Wt as c,c as l,t as u,un as d}from"./esm-BNuSW8ar.js";var f,p,m,h,g,_,v,y;e((()=>{n(),u(),f=t(),p={title:`Core/NavMenu`,component:r,tags:[`autodocs`],argTypes:{size:{control:`select`,options:[`sm`,`md`,`lg`],description:`Size — controls min-width and flows to items for padding`},minWidth:{control:`number`,description:`Minimum width override`}},decorators:[e=>(0,f.jsx)(`div`,{style:{padding:24,maxWidth:300},children:(0,f.jsx)(e,{})})]},m={args:{size:`md`,children:(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(i,{label:`Dashboard`,href:`#`}),(0,f.jsx)(i,{label:`Analytics`,href:`#`}),(0,f.jsx)(i,{label:`Settings`,href:`#`})]})}},h={args:{size:`md`,children:(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(i,{label:`Profile`,icon:l,href:`#`}),(0,f.jsx)(i,{label:`Documents`,icon:o,href:`#`}),(0,f.jsx)(i,{label:`Analytics`,icon:d,href:`#`}),(0,f.jsx)(i,{label:`Security`,icon:s,href:`#`}),(0,f.jsx)(i,{label:`Settings`,icon:c,href:`#`})]})}},g={args:{size:`lg`,children:(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(i,{label:`Profile`,description:`Manage your account settings`,icon:l,href:`#`}),(0,f.jsx)(i,{label:`Settings`,description:`Configure application preferences`,icon:c,href:`#`}),(0,f.jsx)(i,{label:`Sign out`,description:`End your current session`,icon:a})]})}},_={args:{size:`sm`,children:(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(i,{label:`Edit`,href:`#`}),(0,f.jsx)(i,{label:`Duplicate`,href:`#`}),(0,f.jsx)(i,{label:`Delete`})]})}},v={args:{size:`md`,children:(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(i,{label:`Dashboard`,href:`#`}),(0,f.jsx)(i,{label:`Analytics`,href:`#`,isDisabled:!0}),(0,f.jsx)(i,{label:`Settings`,href:`#`}),(0,f.jsx)(i,{label:`Admin`,isDisabled:!0})]})}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    size: 'md',
    children: <>
