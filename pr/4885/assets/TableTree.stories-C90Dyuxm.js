import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{a as i,i as a}from"./columnUtils-ulRI5lEk.js";import{t as o}from"./Table-Q-pd7oGf.js";import{Jt as s,Kt as c,Wt as l,Xt as u,_t as d,ut as f,yt as p}from"./iframe-Bo60kS4Q.js";function m({indent:e}){let{visibleData:t,treeConfig:n}=d({data:_,idKey:`id`,indent:e,defaultExpandedIds:[`eng`,`eng-platform`,`eng-platform-core`]}),r=p(n);return(0,g.jsxs)(`div`,{children:[(0,g.jsxs)(`p`,{style:{marginBlockEnd:8,fontWeight:600},children:[`indent="`,e,`"`]}),(0,g.jsx)(o,{data:t,columns:v,idKey:`id`,plugins:{tree:r}})]})}var h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A;e((()=>{h=t(n()),f(),g=r(),_=[{id:`eng`,name:`Engineering`,title:`VP Engineering`,team:`Engineering`,headcount:48,children:[{id:`eng-platform`,name:`Platform`,title:`Director`,team:`Engineering`,headcount:22,children:[{id:`eng-platform-core`,name:`Core Services`,title:`Manager`,team:`Platform`,headcount:12,children:[{id:`eng-platform-core-api`,name:`API Gateway`,title:`Tech Lead`,team:`Core Services`,headcount:5},{id:`eng-platform-core-data`,name:`Data Pipeline`,title:`Tech Lead`,team:`Core Services`,headcount:7}]},{id:`eng-platform-infra`,name:`Infrastructure`,title:`Manager`,team:`Platform`,headcount:10}]},{id:`eng-product`,name:`Product Engineering`,title:`Director`,team:`Engineering`,headcount:26,children:[{id:`eng-product-web`,name:`Web`,title:`Manager`,team:`Product Engineering`,headcount:14},{id:`eng-product-mobile`,name:`Mobile`,title:`Manager`,team:`Product Engineering`,headcount:12}]}]},{id:`design`,name:`Design`,title:`VP Design`,team:`Design`,headcount:11,children:[{id:`design-systems`,name:`Design Systems`,title:`Manager`,team:`Design`,headcount:4},{id:`design-research`,name:`Research`,title:`Manager`,team:`Design`,headcount:7}]},{id:`ops`,name:`Operations`,title:`VP Operations`,team:`Operations`,headcount:6}],v=[{key:`name`,header:`Group`,width:i(2)},{key:`title`,header:`Lead`,width:i(1)},{key:`team`,header:`Parent team`,width:i(1)},{key:`headcount`,header:`Headcount`,width:a(110),align:`end`}],y=v.map(e=>e.key===`name`||e.key===`headcount`?{...e,sortable:!0,sortKey:e.key}:e),b={title:`Core/TableTree`,tags:[`autodocs`]},x={render:()=>{let{visibleData:e,treeConfig:t}=d({data:_,idKey:`id`,defaultExpandedIds:[`eng`]}),n=p(t);return(0,g.jsx)(o,{data:e,columns:v,idKey:`id`,hasHover:!0,plugins:{tree:n}})}},S={render:()=>{let{visibleData:e,treeConfig:t,expandAll:n,collapseAll:r}=d({data:_,idKey:`id`,defaultExpandedIds:[`eng`,`eng-platform`,`eng-platform-core`]}),i=p(t);return(0,g.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:12},children:[(0,g.jsxs)(`div`,{style:{display:`flex`,gap:8},children:[(0,g.jsx)(`button`,{type:`button`,onClick:n,children:`Expand all`}),(0,g.jsx)(`button`,{type:`button`,onClick:r,children:`Collapse all`})]}),(0,g.jsx)(o,{data:e,columns:v,idKey:`id`,hasHover:!0,plugins:{tree:i}})]})}},C={render:()=>{let{visibleData:e,treeConfig:t}=d({data:_,idKey:`id`,defaultExpandedIds:[`eng`]}),n=p({...t,hasExpandAllControl:!0});return(0,g.jsx)(o,{data:e,columns:v,idKey:`id`,hasHover:!0,plugins:{tree:n}})}},w={render:()=>{let{visibleData:e,treeConfig:t}=d({data:_,idKey:`id`,defaultExpandedIds:[`eng`]}),n=p({...t,hasRowClickExpansion:!0});return(0,g.jsx)(o,{data:e,columns:v,idKey:`id`,hasHover:!0,plugins:{tree:n}})}},T={render:()=>(0,g.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:32},children:[`sm`,`md`,`lg`].map(e=>(0,g.jsx)(m,{indent:e},e))})},E={render:()=>{let[e,t]=(0,h.useState)(()=>new Set([`design-systems`])),{visibleData:n,treeConfig:r}=d({data:_,idKey:`id`,defaultExpandedIds:[`eng`,`design`]}),{selectionConfig:i}=s({data:n,idKey:`id`,selectedKeys:e,setSelectedKeys:t}),a=p(r),c=u(i);return(0,g.jsx)(o,{data:n,columns:v,idKey:`id`,hasHover:!0,plugins:{tree:a,selection:c}})}},D={render:()=>{let{sortConfig:e,applySort:t}=l({data:_,defaultSort:[{sortKey:`headcount`,direction:`descending`}]}),{visibleData:n,treeConfig:r}=d({data:_,idKey:`id`,defaultExpandedIds:[`eng`,`eng-platform`],sortSiblings:t}),i=p(r),a=c(e);return(0,g.jsx)(o,{data:n,columns:y,idKey:`id`,hasHover:!0,plugins:{sort:a,tree:i}})}},O={render:()=>{let[e,t]=(0,h.useState)([{id:`remote`,name:`Remote team`,title:`Director`,team:`—`,headcount:9}]),[n,r]=(0,h.useState)(()=>new Set),{visibleData:i,treeConfig:a}=d({data:e,idKey:`id`,isItemExpandable:e=>e.id===`remote`,onExpandedIdsChange:n=>{!n.has(`remote`)||e[0].children||(r(new Set([`remote`])),window.setTimeout(()=>{t([{...e[0],children:[{id:`remote-emea`,name:`EMEA`,title:`Manager`,team:`Remote team`,headcount:5},{id:`remote-apac`,name:`APAC`,title:`Manager`,team:`Remote team`,headcount:4}]}]),r(new Set)},600))}}),s=p(a);return(0,g.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:8},children:[(0,g.jsx)(o,{data:i,columns:v,idKey:`id`,hasHover:!0,plugins:{tree:s}}),n.size>0&&(0,g.jsx)(`p`,{children:`Loading children…`})]})}},k={render:()=>{let{visibleData:e,treeConfig:t}=d({data:[{id:`a`,name:`Engineering`,title:`VP Engineering`,team:`—`,headcount:48},{id:`b`,name:`Design`,title:`VP Design`,team:`—`,headcount:11},{id:`c`,name:`Operations`,title:`VP Operations`,team:`—`,headcount:6}],idKey:`id`}),n=p(t);return(0,g.jsx)(o,{data:e,columns:v,idKey:`id`,hasHover:!0,plugins:{tree:n}})}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  render: () => {
    const {
      visibleData,
      treeConfig
