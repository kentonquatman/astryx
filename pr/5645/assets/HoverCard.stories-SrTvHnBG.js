...
}`,...w.parameters?.docs?.source},description:{story:`Touch has no hover, so a tap decides instead. A tap-opened card is dismissed
by a tap outside it, and a tap on the card's own content leaves it open.`,...w.parameters?.docs?.description}}},T=[`Default`,`Below`,`Start`,`End`,`CustomDelay`,`Disabled`,`AllPlacements`,`WithHook`,`InteractiveContent`,`TextNode`,`TextNodeMultiple`,`TouchTriggers`]}))();export{y as AllPlacements,m as Below,_ as CustomDelay,p as Default,v as Disabled,g as End,x as InteractiveContent,h as Start,S as TextNode,C as TextNodeMultiple,w as TouchTriggers,b as WithHook,T as __namedExportsOrder,f as default};