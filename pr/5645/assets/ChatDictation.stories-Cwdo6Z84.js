import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{Br as i,Wr as a,_r as o,vr as s,xr as c}from"./iframe-BV8YN37_.js";var l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w;e((()=>{o(),l=t(n()),u=r(),d={volume:0,rawBands:[0,0,0,0,0],bands:[0,0,0,0,0],isSupported:!0,isListening:!1,isSpeaking:!1,interimTranscript:``,start:()=>{},stop:()=>{},abort:()=>{},toggle:()=>{}},f={volume:.05,rawBands:[.08,.06,.04,.02,.01],bands:[.08,.06,.04,.02,.01],isSupported:!0,isListening:!0,isSpeaking:!1,interimTranscript:``,start:()=>{},stop:()=>{},abort:()=>{},toggle:()=>{}},p={volume:.12,rawBands:[.15,.12,.08,.05,.02],bands:[.15,.12,.08,.05,.02],isSupported:!0,isListening:!0,isSpeaking:!0,interimTranscript:`hello world`,start:()=>{},stop:()=>{},abort:()=>{},toggle:()=>{}},m={volume:0,rawBands:[0,0,0,0,0],bands:[0,0,0,0,0],isSupported:!1,isListening:!1,isSpeaking:!1,interimTranscript:``,start:()=>{},stop:()=>{},abort:()=>{},toggle:()=>{}},h={title:`Core/ChatDictation`,component:s,tags:[`autodocs`],parameters:{layout:`centered`},decorators:[e=>(0,u.jsx)(`div`,{style:{width:600,padding:40},children:(0,u.jsx)(e,{})})]},g={render:()=>(0,u.jsx)(s,{dictation:d})},_={render:()=>(0,u.jsx)(s,{dictation:f})},v={render:()=>(0,u.jsx)(s,{dictation:p})},y={render:()=>(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`p`,{style:{marginBottom:8},children:`Button is hidden when unsupported (nothing below):`}),(0,u.jsx)(s,{dictation:m})]})},b={render:()=>(0,u.jsx)(s,{dictation:m,isHiddenWhenUnsupported:!1})},x={render:()=>(0,u.jsx)(i,{onSubmit:e=>console.log(`Submit:`,e),sendActions:(0,u.jsx)(s,{dictation:d})})},S={render:()=>(0,u.jsx)(i,{onSubmit:e=>console.log(`Submit:`,e),sendButton:(0,u.jsx)(s,{dictation:f})})},C={render:()=>{let e=(0,l.useRef)(null),t=c({inputRef:e,hasSounds:!0,onResult:e=>{console.log(`Final:`,e)}});return(0,u.jsxs)(`div`,{children:[(0,u.jsx)(i,{onSubmit:e=>{console.log(`Submit:`,e)},input:(0,u.jsx)(a,{handleRef:e}),sendActions:(0,u.jsx)(s,{dictation:t})}),t.isListening&&(0,u.jsxs)(`div`,{style:{marginTop:8,display:`flex`,alignItems:`center`,gap:8},children:[(0,u.jsx)(`span`,{style:{fontSize:12,opacity:.5},children:`Volume:`}),(0,u.jsx)(`div`,{style:{width:120,height:8,backgroundColor:`#eee`,borderRadius:4,overflow:`hidden`},children:(0,u.jsx)(`div`,{style:{height:`100%`,backgroundColor:t.volume>.3?`#ef4444`:`#22c55e`,borderRadius:4,transition:`width 0.08s ease-out`,width:`${Math.min(t.volume*100*2,100)}%`}})}),(0,u.jsx)(`span`,{style:{fontSize:12,fontFamily:`monospace`,opacity:.5},children:t.volume.toFixed(2)})]}),t.isListening&&(0,u.jsxs)(`div`,{style:{marginTop:12},children:[(0,u.jsx)(`div`,{style:{fontSize:12,fontWeight:600,marginBottom:4},children:`Band Debug (raw vs calibrated)`}),(0,u.jsx)(`div`,{style:{display:`flex`,gap:8,fontFamily:`monospace`,fontSize:11},children:[`170-340`,`340-860`,`860-1.7k`,`1.7-3k`,`3k+`].map((e,n)=>{let r=t.rawBands[n]??0,i=t.bands[n]??0;return(0,u.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:2,flex:1},children:[(0,u.jsxs)(`div`,{style:{display:`flex`,gap:2,alignItems:`flex-end`,height:40},children:[(0,u.jsx)(`div`,{style:{width:8,backgroundColor:`rgba(200,200,200,0.5)`,height:Math.min(r*40*5,40),borderRadius:2}}),(0,u.jsx)(`div`,{style:{width:8,backgroundColor:`#3b82f6`,height:Math.min(i*40*5,40),borderRadius:2}})]}),(0,u.jsx)(`span`,{style:{opacity:.5,fontSize:9},children:e}),(0,u.jsxs)(`span`,{style:{opacity:.4},children:[`r:`,r.toFixed(3)]}),(0,u.jsxs)(`span`,{style:{color:`#3b82f6`},children:[`c:`,i.toFixed(3)]})]},e)})}),(0,u.jsx)(`div`,{style:{fontSize:10,opacity:.4,marginTop:4},children:`Gray = raw mic, Blue = after noise floor`})]}),!t.isSupported&&(0,u.jsx)(`p`,{style:{marginTop:8,color:`red`},children:`SpeechRecognition is not supported in this browser.`})]})}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
