import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{E as r,O as i}from"./ime-ByhR7fBS.js";import{P as a,t as o}from"./utils-5hOvTTOG.js";import{t as s}from"./jsx-runtime-DqZldVDK.js";import{n as c}from"./useTooltip-DGLwCNlL.js";import{l,t as u}from"./i18n-BzB2E-CP.js";import{t as d}from"./Tooltip-3MjpwZf2.js";import{n as f,t as p}from"./Field-BdJkK6cO.js";import{a as m,i as h,n as g,o as _,r as v,s as y}from"./List-CAAl9chh.js";import{i as b,n as x,r as S,t as C}from"./CheckboxInput-iU8gPM7R.js";function w({label:e,isLabelHidden:t=!1,description:n,status:r,value:o,onChange:s,changeAction:l,density:u=`balanced`,hasDividers:d=!1,isDisabled:f=!1,disabledMessage:m,isReadOnly:g=!1,children:_,ref:v,width:y,xstyle:b,className:x,style:C,"data-testid":w,...O}){let k=(0,T.useId)(),A=(0,T.useId)(),j=(0,T.useId)(),M=(0,T.useId)(),[,N]=(0,T.useTransition)(),P=o!==void 0,[F,I]=(0,T.useOptimistic)(o??D),[L,R]=(0,T.useOptimistic)(null),z=f&&!!m,B=c({placement:`above`,focusTrigger:`always`,isEnabled:z}),V=(0,T.useCallback)((e,t)=>{s?.(e),l&&N(async()=>{I(e),t!==void 0&&R(t),await l(e)})},[s,l,N,I,R]),H=(0,T.useMemo)(()=>({value:P?F:void 0,onChange:P?V:void 0,isDisabled:f,hasDisabledMessage:z,isReadOnly:g,loadingValue:L}),[P,F,V,f,z,g,L]);return(0,E.jsxs)(p,{...O,ref:v,"data-testid":w,label:e,isLabelHidden:t,description:n,inputID:k,labelID:A,isGroupLabel:!0,descriptionID:n?j:void 0,isDisabled:f,status:r?{type:r.type,message:r.message,messageID:r.message?M:void 0}:void 0,statusVariant:`detached`,width:y,xstyle:b,...a(i(`checkbox-list`),{className:x,style:C}),children:[(0,E.jsx)(S,{value:H,children:(0,E.jsx)(`div`,{ref:e=>{B.ref(e)},role:`group`,"aria-labelledby":A,"aria-describedby":[n?j:null,r?.message?M:null,z?B.describedBy:null].filter(Boolean).join(` `)||void 0,children:(0,E.jsx)(h,{density:u,hasDividers:d,children:_})})}),z&&B.renderTooltip(m)]})}var T,E,D,O=e((()=>{T=t(n(),1),f(),m(),d(),o(),r(),b(),E=s(),D=[],w.displayName=`CheckboxList`,w.__docgenInfo={description:`A checkbox group component for multi-value selection.
...
@default false`,defaultValue:{value:`false`,computed:!1}},width:{required:!1,tsType:{name:`union`,raw:`number | string`,elements:[{name:`number`},{name:`string`}]},description:"Width of the field. Numbers are treated as pixels, strings are used as-is\n(e.g. `'100%'`). Sizes the whole field (label, control, and status) so they\nstay aligned, unlike setting width via `xstyle`/`className`/`style`."},children:{required:!0,tsType:{name:`ReactNode`},description:`Checkbox list items to render.`}},composes:[`Omit`]}}));function k({label:e,"aria-label":t,value:n,description:r,endContent:i,isDisabled:a=!1,isLoading:o=!1,isChecked:s,onCheck:c,ref:u,xstyle:d,className:f,style:p,onClick:m,...h}){let v=l(),y=(0,A.use)(S);if(y&&y.value!==void 0&&n===void 0)throw Error("CheckboxListItem requires a `value` prop when used inside CheckboxList with a value array.");let b=typeof e!=`string`,x=(0,A.useId)(),w=b&&t==null,T=t??(b?v(`@astryx.checkboxList.item.checkbox`):e),E=((0,A.use)(_)?.density??`balanced`)===`compact`?`sm`:`md`,D=(y?.isDisabled??!1)||a,O=y?.isReadOnly??!1,k=o||(y?.loadingValue!=null&&n!==void 0?y.loadingValue===n:!1),N=!1;y&&y.value!==void 0&&n!==void 0?N=y.value.includes(n):s!==void 0&&(N=s);let P=!O&&(y!=null||c!=null),F=(0,A.useRef)(null),I=P||m!=null,L=()=>{D||O||k||(y&&y.value!==void 0&&n!==void 0?y.value.includes(n)?y.onChange?.(y.value.filter(e=>e!==n),n):y.onChange?.([...y.value,n],n):c?.(N!==!0))};return(0,j.jsx)(g,{...h,ref:u,label:w?(0,j.jsx)(`span`,{id:x,children:e}):e,description:r,endContent:i,isDisabled:D,interactiveRef:I?F:void 0,"aria-busy":k||void 0,xstyle:[N===!0&&!D&&!O&&M.selected,d],className:f,style:p,startContent:(0,j.jsx)(C,{ref:F,label:T,"aria-labelledby":w?x:void 0,isLabelHidden:!0,value:N,onChange:()=>L(),onClick:m,isDisabled:D,isReadOnly:O,isLoading:k,size:E})})}var A,j,M,N=e((()=>{A=t(n(),1),x(),v(),y(),b(),u(),j=s(),M={selected:{kWkggS:`astryxgcxg3y`,$$css:!0}},k.displayName=`CheckboxListItem`,k.__docgenInfo={description:`A checkbox item for use within CheckboxList (collection mode)
