...
@default 'More information'`,defaultValue:{value:`'More information'`,computed:!1}},size:{required:!1,tsType:{name:`union`,raw:`keyof typeof iconSizeValues`,elements:[{name:`literal`,value:`xsm`},{name:`literal`,value:`sm`},{name:`literal`,value:`md`},{name:`literal`,value:`lg`}]},description:`Size of the info icon.
