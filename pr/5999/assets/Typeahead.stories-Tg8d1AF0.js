  ...
  render: () => {
    ...
    return <div style={{
      width: 320
        ...
        <Typeahead label="Fruit" placeholder="Type to search…" searchSource={fruitSource} value={value} onChange={setValue} hasClear isLoading />
      </div>;
  },
  name: 'Input busy (isLoading)'
}`,...N.parameters?.docs?.source},description:{story:`The other busy meaning. The search is idle; the VALUE is being resolved or
saved, which is what the input-field family's \`isLoading\` describes. The
field stays editable and the source's results stay selectable.`,...N.parameters?.docs?.description}}},P.parameters={...P.parameters,docs:{...P.parameters?.docs,source:{originalSource:`{
  render: () => {
    const [value, setValue] = useState<SearchableItem | null>(null);
    return <div style={{
      width: 320
    }}>
        <Typeahead label="Fruit" placeholder="Type to search…" searchSource={fruitSource} value={value} onChange={() => {}} changeAction={async item => {
...
}`,...P.parameters?.docs?.source},description:{story:`\`changeAction\` after every selection and clear. The proposed value shows at
...
synchronously in \`onChange\` accepts it immediately and is never busy.`,...P.parameters?.docs?.description}}},F.parameters={...F.parameters,docs:{...F.parameters?.docs,source:{originalSource:`{
  render: () => {
...
}`,...F.parameters?.docs?.source},description:{story:`The two cases no Typeahead story covered, which is why a bug this visible
...
comparison — the two must be the same width.`,...F.parameters?.docs?.description}}},I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  render: () => {
  ...
  name: 'Logical order'
}`,...I.parameters?.docs?.source},description:{story:`One field with a selected value and a clear button — the two ends of the
...
the audit's selectors would match across both.`,...I.parameters?.docs?.description}}},L.parameters={...L.parameters,docs:{...L.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    width: 320
  }}>
...
}`,...L.parameters?.docs?.source},description:{story:`The inline-end lane, populated at rest, for the RTL audit's D4 pass.
...
the audit measures the geometry the indicator lands in.`,...L.parameters?.docs?.description}}},R=[`Default`,`WithBootstrap`,`Required`,`Optional`,`WithDescription`,`WithError`,`WithWarning`,`WithSuccess`,`Disabled`,`DisabledWithMessage`,`NoClear`,`LimitedResults`,`MinQueryLength`,`SizeVariants`,`WithStartIcon`,`StatusVariantComparison`,`Loading`,`InputBusy`,`TransitionAction`,`SelectedValueInAContentSizedParent`,`LogicalOrder`,`RtlEndLane`]}))();export{g as Default,w as Disabled,T as DisabledWithMessage,N as InputBusy,D as LimitedResults,M as Loading,I as LogicalOrder,O as MinQueryLength,E as NoClear,y as Optional,v as Required,L as RtlEndLane,F as SelectedValueInAContentSizedParent,k as SizeVariants,j as StatusVariantComparison,P as TransitionAction,_ as WithBootstrap,b as WithDescription,x as WithError,A as WithStartIcon,C as WithSuccess,S as WithWarning,R as __namedExportsOrder,h as default};