...
}`,...C.parameters?.docs?.source},description:{story:`Touch has no hover, so a tap decides instead — and what the trigger does
decides for it. Try these on a phone, or in a device emulator with touch
emulation on.`,...C.parameters?.docs?.description}}},w=[`Default`,`Below`,`Start`,`End`,`CustomDelay`,`Disabled`,`AllPlacements`,`WithHook`,`LongContent`,`MultipleTooltips`,`TextNode`,`TextNodeInline`,`TouchTriggers`]}))();export{_ as AllPlacements,f as Below,h as CustomDelay,d as Default,g as Disabled,m as End,y as LongContent,b as MultipleTooltips,p as Start,x as TextNode,S as TextNodeInline,C as TouchTriggers,v as WithHook,w as __namedExportsOrder,u as default};