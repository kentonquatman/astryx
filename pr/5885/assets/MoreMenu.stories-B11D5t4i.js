import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./jsx-runtime-DqZldVDK.js";import{t as n}from"./Button-CfW3rq_M.js";import{t as r}from"./Button-DewtwCMv.js";import{B as i,V as a}from"./iframe-CLaZ5kqw.js";import{Ht as o,I as s,O as c,Pn as l,Pt as u,m as d,t as f}from"./esm-CL1f8dHF.js";var p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k;e((()=>{i(),r(),f(),p=t(),m={title:`Core/MoreMenu`,component:a,tags:[`autodocs`],parameters:{layout:`centered`},argTypes:{items:{description:`Menu items (items, dividers, or sections)`},label:{control:`text`,description:`Accessible label for the trigger button`},variant:{control:`select`,options:[`primary`,`secondary`,`ghost`,`destructive`],description:`Visual style variant of the trigger button`},size:{control:`select`,options:[`sm`,`md`,`lg`],description:`Size of the trigger button`},isDisabled:{control:`boolean`,description:`Whether the menu trigger is disabled`},placement:{control:`select`,options:[`above`,`below`,`start`,`end`],description:`Position of the menu relative to the trigger`},alignment:{control:`select`,options:[`start`,`center`,`end`],description:`Alignment of the menu along the placement axis`},presentation:{control:`select`,options:[`popover`,`bottom-sheet`,`adaptive`],description:`Popover, BottomSheet, or adaptive compact-touch presentation`},"data-testid":{control:`text`,description:`Test ID for testing frameworks`}}},h={render:()=>(0,p.jsx)(a,{items:[{label:`Edit`,onClick:()=>console.log(`Edit clicked`)},{label:`Duplicate`,onClick:()=>console.log(`Duplicate clicked`)},{label:`Delete`,onClick:()=>console.log(`Delete clicked`)}]})},g={render:()=>(0,p.jsx)(a,{items:[{label:`Edit`,icon:s,onClick:()=>console.log(`Edit`)},{label:`Duplicate`,icon:u,onClick:()=>console.log(`Duplicate`)},{label:`Download`,icon:l,onClick:()=>console.log(`Download`)},{label:`Share`,icon:c,onClick:()=>console.log(`Share`)}]})},_={render:()=>(0,p.jsx)(a,{items:[{label:`Edit`,icon:s,onClick:()=>console.log(`Edit`)},{label:`Duplicate`,icon:u,onClick:()=>console.log(`Duplicate`)},{type:`divider`},{label:`Delete`,icon:d,onClick:()=>console.log(`Delete`)}]})},v={render:()=>(0,p.jsx)(a,{label:`Document actions`,items:[{type:`section`,title:`Actions`,items:[{label:`Edit`,icon:s,onClick:()=>console.log(`Edit`)},{label:`Duplicate`,icon:u,onClick:()=>console.log(`Duplicate`)}]},{type:`section`,title:`Danger zone`,items:[{label:`Delete`,icon:d,onClick:()=>console.log(`Delete`)}]}]})},y={render:()=>(0,p.jsx)(a,{size:`sm`,label:`Row actions`,items:[{label:`Edit`,icon:s,onClick:()=>console.log(`Edit`)},{type:`divider`},{label:`Delete`,icon:d,onClick:()=>console.log(`Delete`)}]})},b={render:()=>(0,p.jsxs)(`div`,{style:{display:`flex`,gap:16,alignItems:`center`},children:[(0,p.jsx)(a,{variant:`ghost`,label:`Ghost variant`,items:[{label:`Action`,onClick:()=>{}}]}),(0,p.jsx)(a,{variant:`secondary`,label:`Secondary variant`,items:[{label:`Action`,onClick:()=>{}}]}),(0,p.jsx)(a,{variant:`primary`,label:`Primary variant`,items:[{label:`Action`,onClick:()=>{}}]})]})},x={render:()=>(0,p.jsx)(a,{isDisabled:!0,items:[{label:`Edit`,onClick:()=>console.log(`Edit`)},{label:`Delete`,onClick:()=>console.log(`Delete`)}]})},S={render:()=>(0,p.jsxs)(`div`,{style:{display:`flex`,gap:8,alignItems:`center`},children:[(0,p.jsx)(n,{label:`Save`,variant:`primary`,onClick:()=>{}}),(0,p.jsx)(n,{label:`Preview`,variant:`secondary`,onClick:()=>{}}),(0,p.jsx)(a,{label:`More actions`,items:[{label:`Export`,icon:l,onClick:()=>console.log(`Export`)},{label:`Share`,icon:c,onClick:()=>console.log(`Share`)},{type:`divider`},{label:`Delete`,icon:d,onClick:()=>console.log(`Delete`)}]})]})},C={name:`Presentation / BottomSheet`,parameters:{layout:`fullscreen`,viewport:{defaultViewport:`mobile1`},docs:{story:{inline:!1,height:`560px`},description:{story:`The real MoreMenu component using DropdownMenu’s BottomSheet presentation. Its visible kebab trigger remains the discoverable mobile entry point.`}}},render:()=>(0,p.jsx)(`div`,{style:{padding:16,display:`flex`,justifyContent:`flex-end`},children:(0,p.jsx)(a,{presentation:`bottom-sheet`,label:`Project actions`,items:[{label:`Edit`,icon:s,onClick:()=>{}},{label:`Duplicate`,icon:u,onClick:()=>{}},{label:`Share`,icon:c,onClick:()=>{}},{label:`Delete`,icon:d,variant:`destructive`,onClick:()=>{}}]})}),play:async({canvasElement:e})=>{let t=e.querySelector(`button`);t instanceof HTMLElement&&t.click()}},w={name:`Presentation / adaptive`,parameters:{layout:`fullscreen`,viewport:{defaultViewport:`mobile1`},docs:{description:{story:`Uses the built-in adaptive policy: BottomSheet at 768px and below with a coarse primary pointer, anchored popover otherwise. Use device emulation to exercise the touch branch.`}}},render:()=>(0,p.jsx)(`div`,{style:{padding:16,display:`flex`,justifyContent:`flex-end`},children:(0,p.jsx)(a,{presentation:`adaptive`,label:`Project actions`,items:[{label:`Edit`,icon:s,onClick:()=>{}},{label:`Share`,icon:c,onClick:()=>{}},{label:`Delete`,icon:d,variant:`destructive`,onClick:()=>{}}]})})},T={render:()=>(0,p.jsx)(a,{label:`User actions`,items:[{label:`Alice Johnson`,onClick:()=>console.log(`Alice`)},{label:`Bob Smith`,onClick:()=>console.log(`Bob`)},{label:`Carol Williams`,onClick:()=>console.log(`Carol`)}]})},E={render:()=>(0,p.jsx)(a,{items:[{label:`Edit`,icon:s,onClick:()=>console.log(`Edit`)},{label:`Duplicate`,icon:u,onClick:()=>console.log(`Duplicate`),isDisabled:!0},{type:`divider`},{label:`Delete`,icon:d,onClick:()=>console.log(`Delete`),isDisabled:!0}]})},D={parameters:{layout:`padded`},render:()=>(0,p.jsxs)(`div`,{style:{display:`flex`,gap:240,justifyContent:`center`,paddingBlock:120},children:[(0,p.jsx)(a,{label:`Start aligned`,items:[{label:`Edit`,icon:s,onClick:()=>{}},{label:`Duplicate`,icon:u,onClick:()=>{}},{type:`divider`},{label:`Delete`,icon:d,onClick:()=>{}}]}),(0,p.jsx)(a,{label:`End aligned`,alignment:`end`,items:[{label:`Edit`,icon:s,onClick:()=>{}},{label:`Duplicate`,icon:u,onClick:()=>{}},{type:`divider`},{label:`Delete`,icon:d,onClick:()=>{}}]})]})},O={render:()=>(0,p.jsxs)(`div`,{style:{display:`flex`,gap:16,alignItems:`center`},children:[(0,p.jsx)(a,{icon:(0,p.jsx)(o,{}),label:`Settings`,items:[{label:`Preferences`,onClick:()=>console.log(`Preferences`)},{label:`Account`,onClick:()=>console.log(`Account`)},{label:`Logout`,onClick:()=>console.log(`Logout`)}]}),(0,p.jsx)(a,{icon:(0,p.jsx)(s,{}),label:`Edit options`,items:[{label:`Edit title`,onClick:()=>console.log(`Edit title`)},{label:`Edit description`,onClick:()=>console.log(`Edit description`)}]})]})},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
