...
`),v={name:`Streaming`,render:()=>{let e=_,[t,n]=(0,c.useState)(0),[r,a]=(0,c.useState)(!0),[s,u]=(0,c.useState)(0);return(0,c.useEffect)(()=>{if(!r)return;if(t>=e.length){a(!1);return}let i=Math.floor(Math.random()*8)+2,o=30+Math.random()*60,s=setTimeout(()=>{n(t=>Math.min(t+i,e.length))},o);return()=>clearTimeout(s)},[t,r,e]),(0,l.jsxs)(`div`,{children:[(0,l.jsxs)(`div`,{style:{marginBlockEnd:12,display:`flex`,gap:8,alignItems:`center`},children:[(0,l.jsx)(i,{label:`Replay`,variant:`secondary`,size:`sm`,onClick:(0,c.useCallback)(()=>{n(0),a(!0),u(e=>e+1)},[]),isDisabled:r}),(0,l.jsx)(`span`,{style:{fontSize:12,color:`var(--color-text-secondary)`},children:r?`Streaming... ${t}/${e.length}`:`Complete`})]}),(0,l.jsx)(o,{isStreaming:r,density:`compact`,headingLevelStart:3,sources:d,children:e.slice(0,t)},s)]})}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  name: 'Bracket [id]',
  args: {
    children: BRACKET_MD,
