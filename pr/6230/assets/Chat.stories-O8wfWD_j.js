import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./jsx-runtime-DqZldVDK.js";import{t as n}from"./Text-wytiXIro.js";import{t as r}from"./Button-ClsRlxiJ.js";import{t as i}from"./Button-CjtQgiPl.js";import{i as a,t as o}from"./Avatar-DvS8_XL2.js";import{t as s}from"./ClickableCard-BchVLI7B.js";import{n as c,t as l}from"./CodeBlock-BxVJ7-7J.js";import{o as u,t as d}from"./Stack-DlhhdjPh.js";import{t as f}from"./Text-DPxLLoA5.js";import{n as p,t as m}from"./Token-EMxbTr3W.js";import{C as h,Fr as g,Lr as _,Nr as v,_r as y,br as b,hi as x,jr as S,kr as C,vr as w,w as T}from"./iframe-gr2b9Ivs.js";import{Qt as E,ft as D,mt as O,t as k}from"./esm-BNuSW8ar.js";var A,j,M,N,P,F,I,L,R,z,B,V,H;e((()=>{b(),o(),x(),f(),y(),m(),d(),l(),i(),h(),k(),A=t(),j={title:`Core/Chat`,component:_,tags:[`autodocs`]},M={name:`Default`,render:()=>(0,A.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`},children:(0,A.jsxs)(_,{children:[(0,A.jsx)(g,{sender:`user`,children:(0,A.jsx)(v,{metadata:(0,A.jsx)(S,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:30:00`,format:`time`}),status:`read`}),children:`How should I handle state management in a React app?`})}),(0,A.jsxs)(g,{sender:`assistant`,children:[(0,A.jsx)(w,{density:`compact`,children:`For most cases, **React's built-in state** is sufficient:
...
const [state, dispatch] = useReducer(reducer, initialState);`,language:`tsx`}),(0,A.jsx)(w,{density:`compact`,children:"This keeps all your form logic in one place. The reducer is pure and easy to test — just pass in state and action, assert on the output.\n\n| Hook | Use case | Re-renders | Complexity | Best for |\n|------|----------|------------|------------|----------|\n| `useState` | Simple values | On every set | Low | Toggles, inputs, counters |\n| `useReducer` | Complex state logic | On dispatch | Medium | Forms, multi-field state |\n| `useContext` | Shared subtree state | All consumers | Low | Theme, auth, locale |\n| `useSyncExternalStore` | External stores | On snapshot change | High | Redux, Zustand, signals |\n| `useRef` | Mutable values | Never | Low | DOM refs, timers, previous values |"}),(0,A.jsx)(S,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:31:30`,format:`time`}),footer:(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`span`,{children:`Claude Opus 4.6`}),(0,A.jsx)(`span`,{children:`·`}),(0,A.jsx)(r,{label:`Thumbs up`,icon:(0,A.jsx)(D,{style:{width:14,height:14}}),variant:`ghost`,size:`sm`,isIconOnly:!0}),(0,A.jsx)(r,{label:`Thumbs down`,icon:(0,A.jsx)(O,{style:{width:14,height:14}}),variant:`ghost`,size:`sm`,isIconOnly:!0}),(0,A.jsx)(r,{label:`Copy`,icon:(0,A.jsx)(E,{style:{width:14,height:14}}),variant:`ghost`,size:`sm`,isIconOnly:!0})]})})]})]})})},N={name:`Mixed Content`,render:()=>(0,A.jsx)(`div`,{style:{height:600,display:`flex`,flexDirection:`column`},children:(0,A.jsxs)(_,{children:[(0,A.jsx)(g,{sender:`user`,children:(0,A.jsx)(v,{children:`Show me the component files and explain the architecture`})}),(0,A.jsxs)(g,{sender:`assistant`,children:[(0,A.jsx)(v,{children:`Sure! Here's an overview of the component architecture.`}),(0,A.jsx)(v,{variant:`ghost`,children:(0,A.jsx)(w,{density:`compact`,children:`The system uses a **compound component** pattern with three layers:

1. **MessageList** — scrollable container with auto-scroll
2. **Message** — layout wrapper with sender context
3. **Bubble** — styled content container`})}),(0,A.jsxs)(v,{variant:`ghost`,children:[(0,A.jsx)(w,{density:`compact`,children:`Here are the files:`}),(0,A.jsxs)(u,{gap:2,wrap:`wrap`,children:[(0,A.jsx)(p,{label:`Button.tsx`}),(0,A.jsx)(p,{label:`Card.tsx`}),(0,A.jsx)(p,{label:`Dialog.tsx`})]}),(0,A.jsx)(c,{code:`export * from './Button';
export * from './Card';
export * from './Dialog';`,language:`typescript`})]}),(0,A.jsx)(v,{children:`Let me know which one to open — I can walk through the implementation.`})]}),(0,A.jsx)(g,{sender:`user`,children:(0,A.jsx)(v,{children:`Open Button.tsx`})}),(0,A.jsx)(C,{children:`Navi opened Button.tsx`}),(0,A.jsx)(g,{sender:`assistant`,children:(0,A.jsxs)(v,{variant:`ghost`,children:[(0,A.jsx)(c,{code:`import * as stylex from '@stylexjs/stylex';
...
This is the **${t}** density. ${t===`compact`?`Great for sidebars and panels where space is limited.`:t===`spacious`?`Ideal for long-form reading where breathing room helps comprehension.`:`The default — works well for most full-page chat interfaces.`}`})}),(0,A.jsx)(g,{sender:`user`,children:(0,A.jsx)(v,{children:`Makes sense, thanks!`})})]})})]});return(0,A.jsxs)(`div`,{style:{display:`flex`,gap:16,height:500},children:[t(`compact`),t(`balanced`),t(`spacious`)]})}},L={name:`Message Gap Override`,render:()=>(0,A.jsx)(`div`,{style:{height:420,display:`flex`,flexDirection:`column`},children:(0,A.jsxs)(_,{density:`compact`,gap:5,children:[(0,A.jsx)(g,{sender:`assistant`,children:(0,A.jsx)(v,{name:`Clio`,children:`Starting the requested change.`})}),(0,A.jsx)(g,{sender:`assistant`,children:(0,A.jsx)(v,{variant:`ghost`,children:`Reading repository context and relevant files...`})}),(0,A.jsx)(g,{sender:`assistant`,children:(0,A.jsx)(v,{variant:`ghost`,children:`Running tests for the updated package.`})}),(0,A.jsx)(g,{sender:`assistant`,children:(0,A.jsx)(v,{metadata:(0,A.jsx)(S,{footer:`Done`}),children:`The patch is ready for review.`})})]})})},R={name:`System Messages`,render:()=>(0,A.jsx)(`div`,{style:{height:400,display:`flex`,flexDirection:`column`},children:(0,A.jsxs)(_,{children:[(0,A.jsx)(C,{variant:`divider`,children:`March 15, 2026`}),(0,A.jsx)(g,{sender:`assistant`,avatar:(0,A.jsx)(a,{name:`Navi`,size:`md`}),children:(0,A.jsx)(w,{density:`compact`,children:`Good morning!`})}),(0,A.jsx)(C,{children:`Conversation started`}),(0,A.jsx)(g,{sender:`user`,children:(0,A.jsx)(v,{children:`Hey Navi`})}),(0,A.jsx)(C,{variant:`divider`,children:`Today`}),(0,A.jsx)(C,{children:`Cindy shared a file`})]})})},z={name:`Message Status`,render:()=>(0,A.jsx)(`div`,{style:{height:400,display:`flex`,flexDirection:`column`},children:(0,A.jsxs)(_,{children:[(0,A.jsx)(g,{sender:`user`,children:(0,A.jsx)(v,{metadata:(0,A.jsx)(S,{status:`sending`}),children:`Sending...`})}),(0,A.jsx)(g,{sender:`user`,children:(0,A.jsx)(v,{metadata:(0,A.jsx)(S,{status:`sent`}),children:`Sent`})}),(0,A.jsx)(g,{sender:`user`,children:(0,A.jsx)(v,{metadata:(0,A.jsx)(S,{status:`delivered`}),children:`Delivered`})}),(0,A.jsx)(g,{sender:`user`,children:(0,A.jsx)(v,{metadata:(0,A.jsx)(S,{status:`read`}),children:`Read`})}),(0,A.jsx)(g,{sender:`user`,children:(0,A.jsx)(v,{metadata:(0,A.jsx)(S,{status:`error`}),children:`Failed to send`})})]})})},B={name:`Multi-Bubble Grouping`,render:()=>(0,A.jsx)(`div`,{style:{height:500,display:`flex`,flexDirection:`column`},children:(0,A.jsxs)(_,{children:[(0,A.jsxs)(g,{sender:`user`,children:[(0,A.jsx)(v,{group:`first`,children:`Hey, can you review my PR?`}),(0,A.jsx)(v,{group:`middle`,children:`It's the one for the chat components`}),(0,A.jsx)(v,{group:`last`,metadata:(0,A.jsx)(S,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:31:00`,format:`time`}),status:`delivered`}),children:`Link: github.com/facebook/astryx/pull/1180`})]}),(0,A.jsxs)(g,{sender:`assistant`,avatar:(0,A.jsx)(a,{name:`Navi`,size:`md`}),children:[(0,A.jsx)(v,{group:`first`,children:`Sure, looking at it now!`}),(0,A.jsx)(v,{group:`middle`,children:`The compound pattern looks solid. A few minor comments on the density styles.`}),(0,A.jsx)(v,{group:`last`,metadata:(0,A.jsx)(S,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:33:00`,format:`time`})}),children:`I'll leave them as review comments.`})]}),(0,A.jsx)(g,{sender:`user`,children:(0,A.jsx)(v,{metadata:(0,A.jsx)(S,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:34:00`,format:`time`}),status:`sending`}),children:`Thanks, will address those`})})]})})},V={name:`Alignment`,render:()=>{let e=e=>(0,A.jsxs)(`div`,{style:{flex:1,minWidth:0,display:`flex`,flexDirection:`column`,border:`1px solid var(--color-border-primary)`,borderRadius:8,overflow:`hidden`},children:[(0,A.jsxs)(`div`,{style:{padding:`8px 12px`,borderBottom:`1px solid var(--color-border-primary)`,fontSize:12,fontWeight:600,textTransform:`uppercase`,letterSpacing:`0.05em`},children:[`align="`,e,`"`]}),(0,A.jsx)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,minHeight:0},children:(0,A.jsxs)(_,{align:e,children:[(0,A.jsx)(g,{sender:`user`,children:(0,A.jsx)(v,{children:`Just one short message.`})}),(0,A.jsx)(g,{sender:`assistant`,avatar:(0,A.jsx)(a,{name:`Navi`,size:`sm`}),children:(0,A.jsx)(v,{children:e===`top`?`Top alignment keeps messages at the top — good for logs and document-style lists.`:`Bottom alignment keeps a short thread just above the composer — the familiar messaging layout.`})})]})})]});return(0,A.jsxs)(`div`,{style:{display:`flex`,gap:16,height:420},children:[e(`bottom`),e(`top`)]})}},M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
  name: 'Default',
  render: () => <div style={{
    display: 'flex',
