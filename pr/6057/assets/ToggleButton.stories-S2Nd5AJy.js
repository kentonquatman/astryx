import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{t as i}from"./Icon-nqzzJpQf.js";import{t as a}from"./Icon-Dn-zG4Ea.js";import{lt as o,ot as s,st as c}from"./iframe-CVUeBm0w.js";import{E as l,Q as u,S as d,Sn as f,X as p,bn as m,ct as h,et as g,m as _,mn as v,t as y,vn as b,w as x}from"./esm-BNuSW8ar.js";import{P as S,R as C,b as w,c as T,g as E,o as D,t as O}from"./esm-B13qlNX_.js";var k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W;e((()=>{k=t(n()),s(),y(),O(),a(),A=r(),j={width:16,height:16},M={title:`Core/ToggleButton`,component:c,tags:[`autodocs`],argTypes:{label:{control:`text`},isPressed:{control:`boolean`},size:{control:`select`,options:[`sm`,`md`,`lg`]},isDisabled:{control:`boolean`},isLoading:{control:`boolean`}}},N={render:function(){let[e,t]=(0,k.useState)(!1);return(0,A.jsx)(c,{label:`Bold`,icon:(0,A.jsx)(b,{style:j}),isPressed:e,onPressedChange:t,isIconOnly:!0})}},P={render:function(){let[e,t]=(0,k.useState)(!1),[n,r]=(0,k.useState)(!0);return(0,A.jsxs)(`div`,{style:{display:`flex`,gap:8},children:[(0,A.jsx)(c,{label:`Favorite`,icon:(0,A.jsx)(x,{style:j}),pressedIcon:(0,A.jsx)(T,{style:j}),isPressed:e,onPressedChange:t,isIconOnly:!0}),(0,A.jsx)(c,{label:`Bookmark`,icon:(0,A.jsx)(v,{style:j}),pressedIcon:(0,A.jsx)(S,{style:j}),isPressed:n,onPressedChange:r,isIconOnly:!0})]})}},F={render:function(){let[e,t]=(0,k.useState)(!1);return(0,A.jsx)(c,{label:`Active`,isPressed:e,onPressedChange:t,children:`Active`})}},I={args:{label:`Disabled toggle`,isPressed:!1,isDisabled:!0,icon:(0,A.jsx)(b,{style:j})}},L={args:{label:`Loading toggle`,isPressed:!0,isLoading:!0,icon:(0,A.jsx)(x,{style:j})}},R={render:function(){let[e,t]=(0,k.useState)({}),n=e=>t(t=>({...t,[e]:!t[e]}));return(0,A.jsxs)(`div`,{style:{display:`flex`,gap:8,alignItems:`center`},children:[(0,A.jsx)(c,{label:`Small`,size:`sm`,icon:(0,A.jsx)(b,{style:j}),isPressed:!!e.sm,onPressedChange:()=>n(`sm`),isIconOnly:!0}),(0,A.jsx)(c,{label:`Medium`,size:`md`,icon:(0,A.jsx)(b,{style:j}),isPressed:!!e.md,onPressedChange:()=>n(`md`),isIconOnly:!0}),(0,A.jsx)(c,{label:`Large`,size:`lg`,icon:(0,A.jsx)(b,{style:{width:20,height:20}}),isPressed:!!e.lg,onPressedChange:()=>n(`lg`),isIconOnly:!0})]})}},z={render:function(){let[e,t]=(0,k.useState)(`list`);return(0,A.jsxs)(o,{value:e,onChange:t,label:`View mode`,children:[(0,A.jsx)(c,{value:`list`,label:`List view`,icon:(0,A.jsx)(p,{style:j}),isIconOnly:!0}),(0,A.jsx)(c,{value:`grid`,label:`Grid view`,icon:(0,A.jsx)(l,{style:j}),isIconOnly:!0})]})}},B={render:function(){let[e,t]=(0,k.useState)([]);return(0,A.jsxs)(o,{type:`multiple`,value:e,onChange:t,label:`Text formatting`,children:[(0,A.jsx)(c,{value:`bold`,label:`Bold`,icon:(0,A.jsx)(b,{style:j}),isIconOnly:!0}),(0,A.jsx)(c,{value:`italic`,label:`Italic`,icon:(0,A.jsx)(g,{style:j}),isIconOnly:!0}),(0,A.jsx)(c,{value:`underline`,label:`Underline`,icon:(0,A.jsx)(_,{style:j}),isIconOnly:!0})]})}},V={render:function(){let[e,t]=(0,k.useState)(!1);return(0,A.jsx)(c,{label:e?`Unmute notifications`:`Mute notifications`,icon:(0,A.jsx)(m,{style:j}),pressedIcon:(0,A.jsx)(f,{style:j}),isPressed:e,onPressedChange:t,isIconOnly:!0})}},H={render:function(){let[e,t]=(0,k.useState)({bold:!0,italic:!1,underline:!0,strikethrough:!1,link:!1}),n=e=>t(t=>({...t,[e]:!t[e]}));return(0,A.jsxs)(`div`,{style:{display:`flex`,gap:4},children:[(0,A.jsx)(c,{label:`Bold`,icon:(0,A.jsx)(i,{icon:b,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:C,size:`sm`,color:`accent`}),isPressed:e.bold,onPressedChange:()=>n(`bold`),isIconOnly:!0}),(0,A.jsx)(c,{label:`Italic`,icon:(0,A.jsx)(i,{icon:g,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:E,size:`sm`,color:`accent`}),isPressed:e.italic,onPressedChange:()=>n(`italic`),isIconOnly:!0}),(0,A.jsx)(c,{label:`Underline`,icon:(0,A.jsx)(i,{icon:_,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:D,size:`sm`,color:`accent`}),isPressed:e.underline,onPressedChange:()=>n(`underline`),isIconOnly:!0}),(0,A.jsx)(c,{label:`Strikethrough`,icon:(0,A.jsx)(i,{icon:d,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:d,size:`sm`,color:`accent`}),isPressed:e.strikethrough,onPressedChange:()=>n(`strikethrough`),isIconOnly:!0}),(0,A.jsx)(c,{label:`Link`,icon:(0,A.jsx)(i,{icon:u,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:u,size:`sm`,color:`success`}),isPressed:e.link,onPressedChange:()=>n(`link`),isIconOnly:!0})]})}},U={render:function(){let[e,t]=(0,k.useState)({star:!1,heart:!1,bookmark:!0,bell:!1}),n=e=>t(t=>({...t,[e]:!t[e]}));return(0,A.jsxs)(`div`,{style:{display:`flex`,gap:8},children:[(0,A.jsx)(c,{label:`Star`,icon:(0,A.jsx)(i,{icon:x,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:T,size:`sm`,color:`yellow`}),isPressed:e.star,onPressedChange:()=>n(`star`),isIconOnly:!0}),(0,A.jsx)(c,{label:`Like`,icon:(0,A.jsx)(i,{icon:h,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:w,size:`sm`,color:`red`}),isPressed:e.heart,onPressedChange:()=>n(`heart`),isIconOnly:!0}),(0,A.jsx)(c,{label:`Save`,icon:(0,A.jsx)(i,{icon:v,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:S,size:`sm`,color:`blue`}),isPressed:e.bookmark,onPressedChange:()=>n(`bookmark`),isIconOnly:!0}),(0,A.jsx)(c,{label:`Follow`,icon:(0,A.jsx)(i,{icon:m,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:m,size:`sm`,color:`accent`}),isPressed:e.bell,onPressedChange:()=>n(`bell`),isIconOnly:!0})]})}},N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
